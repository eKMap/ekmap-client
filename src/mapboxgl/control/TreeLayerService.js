...
/**
 * @class mapboxgl.ekmap.control.TreeLayerService
 * @category  Control
 * @classdesc TreeLayerService.
 * @param {Object} options Construction parameters.
 * @param {Array} options.baseLayers=null List of baselayer for which you want to display TreeLayerService.
 * @param {Array} options.overLayers=null List of overlayer for which you want to display TreeLayerService.
 * @param {Boolean} options.opacityControl=false Display opacity.
 * @param {string} options.title=TreeLayerService Name of header.
 * @param {String} options.tooltip=TreeLayerService Tooltip of button.
 * 
 *
 * @example
 ...
 * map.on('load', function() {
            ...
            // TreeLayerServiceControl
            let Opacity = new mapboxgl.ekmap.control.TreeLayerService({
 ...
 *
 */
export class TreeLayerService extends mapboxgl.Evented {

    constructor(options) {
        super(options);
        this.options = options || {};
        this.url = this.options.url;
        this.mapService = new mapboxgl.ekmap.MapService({
            url: this.url,
        });
    ...
    /**
     * @function mapboxgl.ekmap.control.TreeLayerService.prototype.onAdd
    ...
    onAdd(map) {
        ...
        this.button.className = 'mapboxgl-btn-TreeLayerService';
        ...
        this.button.addEventListener("click", function(e) {
            ...
            me.mapService.getLayers(function(data) {
                var layers = data.layers;
                for (var i = 0; i < layers.length; i++) {
                    getChildren(layers[i], i)
                }
                var tree1 = new Tree('.treeview1', {
                    // root data
                    data: tree,
                    loaded: function() {
    ...
    /**
     * @function mapboxgl.ekmap.control.TreeLayerService.prototype.onRemove
    ...
    createLayerInputToggle() {
        ...
        header.innerHTML = this.options.title != undefined ? this.options.title : 'TreeLayerService';
...
mapboxgl.ekmap.control.TreeLayerService = TreeLayerService;