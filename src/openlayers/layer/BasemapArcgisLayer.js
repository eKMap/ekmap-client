...
/**
 * @class ol.ekmap.BasemapArcgisLayer
 ...
 *     zoom: 6
 * });
 * var baseMap = new ol.ekmap.BasemapArcgisLayer('Topographic')
 *   .addTo(map);
 */
...
export class BasemapArcgisLayer extends TileLayer {
    ...
    constructor(basemapType) {
        ...
        if (typeof basemapType === 'string' && tiles[basemapType]) {
            ...
            throw new Error('ol.viegis.BasemapArcgisLayer: Invalid parameter. Use one of "Streets", "Topographic", "Oceans", "OceansLabels", "NationalGeographic", "Physical", "Gray", "GrayLabels", "DarkGray", "DarkGrayLabels", "Imagery", "ImageryLabels", "ImageryTransportation", "ImageryClarity", "ImageryFirefly", ShadedRelief", "ShadedReliefLabels", "Terrain", "TerrainLabels" or "USATopo"');
        }
    ...
    /**
     * @function ol.ekmap.BasemapArcgisLayer.prototype.addTo
