...
/**
 * @class ol.ekmap.DomOverlay
 * @classdesc ol.ekmap.DomOverlay 
 * @category Layer
...
export class DomOverlay extends Overlay {
    ...
    _init() {
        let canvasContainer = this.map.getViewport().getElementsByClassName('ol-layer')[0],
            olCanvas = document.querySelector('canvas'),
    ...
    /**
     * @function ol.ekmap.DomOverlay.prototype.setDoms
    ...
    /**
     * @function ol.ekmap.DomOverlay.prototype.findDom
     * @param {string} domId
     */
    findDom(domId) {
    ...
    /**
     * @function ol.ekmap.DomOverlay.prototype.clearDoms
