 ...
 */
var ol_control_BaseLayer = function(options) {
    options = options || {};
    ...
    var cssClasses = className + ' ol-unselectable ol-control ol-full-screen';
...
ekmap_inherits(ol_control_BaseLayer, Control);


ol_control_BaseLayer.prototype.setMap = function(map) {
    this.map = map;
    if (map) {
        this.drawBaseLayer();
    }
 ...
 * @api 
 */
ol_control_BaseLayer.prototype.drawBaseLayer = function() {
    this.baseLayer = {};
    if (this.first) {
 ...
 * @private
 */
ol_control_BaseLayer.prototype.getImageTile_ = function(layer) {
     ...
     * @private
     */
ol_control_BaseLayer.prototype.handleCollapseClick_ = function(evt) {
        if (evt) {
            evt.preventDefault();
            evt.stopPropagation();
        }
     ...
     * @private
     */
ol_control_BaseLayer.prototype.setActiveLayer_ = function(evt) {
        if (evt) {
            evt.preventDefault();
            evt.stopPropagation();
        }
     ...
     * @private
     */
ol_control_BaseLayer.prototype.isMediumScreen_ = function() {
        var x = window.matchMedia("(max-width: 768px)");
     ...
     * @private
     */
ol_control_BaseLayer.prototype.resizeScreen_ = function(evt) {
    this.drawBaseLayer();
}
 ...
 * @private
 */
ol_control_BaseLayer.prototype.formatString = function(str, length) {
    if (!str) return "";
...
export default ol_control_BaseLayer;