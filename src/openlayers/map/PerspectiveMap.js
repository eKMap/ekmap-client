...
import { ekmap_inherits } from '../control/ext/inherits'
...
var PerspectiveMap = function(options) {
    ...
    // Create map inside
    var map = ekmap_element.create('DIV', {
...
ekmap_inherits(PerspectiveMap, ol_Map);

/** Get pixel ratio for the map
 */
PerspectiveMap.prototype.getPixelRatio = function() {
 ...
 */
PerspectiveMap.prototype.setPerspective = function(angle, options) {
    options = options || {};
    // max angle
 ...
 * @private
 */
PerspectiveMap.prototype._animatePerpective = function(t0, t, style, fromAngle, toAngle, duration, easing) {
 ...
 */
PerspectiveMap.prototype.handleMapBrowserEvent = function(e) {
    e.pixel = [
 ...
 */
PerspectiveMap.prototype.getMatrix3D = function(compute) {
    if (compute) {
 ...
 * @param {ol.pixel} 
 */
PerspectiveMap.prototype.getPixelScreenFromCoordinate = function(coord) {
 ...
 * 
 */
PerspectiveMap.prototype.getPixelFromPixelScreen = function(px) {
    // Get transform matrix3D from CSS
...
(function() {
    ...
    ol_Overlay.prototype.updatePixelPosition = function() {
        var map = this.getMap();
        if (map && map instanceof PerspectiveMap) {
