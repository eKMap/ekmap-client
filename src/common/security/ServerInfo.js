...
export class ServerInfo {
    constructor(type, options) {
        /**
         * @member {Ekmap.ServerType} Ekmap.ServerInfo.prototype.type
         * @description 服务器类型
         */
        this.type = type;

        /**
         * @member {string} Ekmap.ServerInfo.prototype.server
         * @description 服务器地址
         */
        this.server = null;

        /**
         * @member {string} [Ekmap.ServerInfo.prototype.tokenServiceUrl]
         * @description 如：http://supermapiserver:8090/iserver/services/security/tokens.json
         */
        this.tokenServiceUrl = null;

        /**
         * @member {string} [Ekmap.ServerInfo.prototype.keyServiceUrl]
        ...
        this.CLASS_NAME = "Ekmap.ServerInfo";
