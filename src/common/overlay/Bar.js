 ...
 * @param {Ekmap.Feature.Theme.Bar.setting} setting - 图表配置对象。
 ...
 * @property {Array.<Ekmap.Feature.ShapeParameters.Polygon.style>} barStyleByFields - 按专题字段 themeFields（<Ekmap.Layer.Graph.themeFields|L.Ekmap.graphThemeLayer.themeFields|ol.source.Graph.themeFields|mapboxgl.Ekmap.GraphThemeLayer.themeFields>）为柱条赋 style，此参数按字段控制柱条样式，优先级低于 barStyleByCodomain，高于 barStyle。此数组中的元素是样式对象。此参数中的 style 与 themeFields 中的字段一一对应 。例如： themeFields（<Ekmap.Layer.Graph.themeFields>） 为 ["POP_1992", "POP_1995", "POP_1999"],barStyleByFields 为[style1, style2, style3]，则在图表中，字段 POP_1992 对应的柱条使用 style1，字段 POP_1995 对应的柱条使用 style2 ，字段 POP_1999 对应的柱条使用 style3。
 * @property {Array.<Ekmap.Feature.ShapeParameters.Polygon.style>} barStyleByCodomain - 按柱条代表的数据值所在值域范围控制柱条样式，优先级高于 barStyle 和 barStyleByFields。
