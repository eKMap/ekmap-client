...
/**
 * @class  Ekmap.Feature.ShapeParameters.Image
...
export class Image extends ShapeParameters {
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Image.prototype.constructor
     ...
     * @returns {Ekmap.Feature.ShapeParameters.Image} 圆形参数对象。
     */
    constructor(x, y, image, width, height, sx, sy, sWidth, sHeight) {
        super(x, y, image, width, height, sx, sy, sWidth, sHeight);
        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Image.prototype.x
         * @description 左上角横坐标，必设参数。
         */
        this.x = x;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Image.prototype.y
         * @description 左上角纵坐标，必设参数。
         */
        this.y = y;

        /**
         * @member {(string|Object)} Ekmap.Feature.ShapeParameters.Image.prototype.image
         * @description 图片地址。
         */
        this.image = image;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Image.prototype.width
         * @description 绘制到画布上的宽度，默认为图片高度。
         */
        this.width = width;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Image.prototype.height
         * @description 绘制到画布上的高度，默认为图片高度。
         */
        this.height = height;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Image.prototype.sx
         * @description 从图片中裁剪的左上角横坐标。
         */
        this.sx = sx;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Image.prototype.sy
         * @description 从图片中裁剪的左上角纵坐标。
         */
        this.sy = sy;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Image.prototype.sWidth
         * @description 从图片中裁剪的宽度，默认为图片高度。
         */
        this.sWidth = sWidth;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Image.prototype.sHeight
         * @description 绘制到画布上的高度，默认为图片高度。
         */
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Image.prototype.destroy
     * @description 销毁对象。
     */
    destroy() {
        this.x = null;
