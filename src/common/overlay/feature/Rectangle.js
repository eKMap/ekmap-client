...
/**
 * @class  Ekmap.Feature.ShapeParameters.Rectangle
...
export class Rectangle extends ShapeParameters {
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Rectangle.prototype.constructor
     ...
     * @returns {Ekmap.Feature.ShapeParameters.Rectangle} 图形矩形参数对象。
     */
    constructor(x, y, width, height) {
        super(x, y, width, height);
        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Rectangle.prototype.x
         * @description 左上角 x 坐标。
         */
        this.x = !isNaN(x) ? x : 0;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Rectangle.prototype.y
         * @description 左上角 y 坐标。
         */
        this.y = !isNaN(x) ? y : 0;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Rectangle.prototype.width
         * @description 宽度。
         */
        this.width = !isNaN(width) ? width : 0;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Rectangle.prototype.height
         * @description 高度。
         */
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Rectangle.prototype.destroy
     * @description 销毁对象。
     */
    destroy() {
        this.x = null;
...
/**
 * @typedef {Object} Ekmap.Feature.ShapeParameters.Rectangle.style
