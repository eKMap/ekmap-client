...
/**
 * @class  Ekmap.Feature.ShapeParameters.Line
...
export class Line extends ShapeParameters {
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Line.prototype.constructor
     * @description 创建一个图形线参数对象。
     * @param {Array} pointList - 线要素节点数组，二维数组，必设参数。
     * @returns {Ekmap.Feature.ShapeParameters.Line} 圆形参数对象。
     */
    constructor(pointList) {
        super(pointList);
        /**
         * @member {Array} Ekmap.Feature.ShapeParameters.Line.prototype.pointList
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Line.prototype.destroy
     * @description 销毁对象。
     */
    destroy() {
        this.pointList = null;
...
/**
 * @typedef {Object} Ekmap.Feature.ShapeParameters.Line.style
