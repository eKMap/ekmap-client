...
/**
 * @class  Ekmap.Feature.ShapeParameters.Polygon
...
export class Polygon extends ShapeParameters {
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Polygon.prototype.constructor
     * @description 创建一个图形面参数对象。
     * @param {Array} pointList - 横坐标，必设参数。
     * @returns {Ekmap.Feature.ShapeParameters.Polygon} 标签参数对象。
     */
    constructor(pointList) {
        super(pointList);
        /**
         * @member {Array} Ekmap.Feature.ShapeParameters.Polygon.prototype.pointList
        ...
        /**
         * @member {Array} Ekmap.Feature.ShapeParameters.Polygon.prototype.holePolygonPointLists
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Polygon.prototype.destroy
     * @description 销毁对象。
     */
    destroy() {
        this.pointList = null;
...
/**
 * @typedef {Object} Ekmap.Feature.ShapeParameters.Polygon.style
