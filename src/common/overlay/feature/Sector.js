...
/**
 * @class  Ekmap.Feature.ShapeParameters.Sector
...
export class Sector extends ShapeParameters {
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Sector.prototype.constructor
     ...
     * @returns {Ekmap.Feature.ShapeParameters.Sector} 扇形参数对象。
     */
    constructor(x, y, r, startAngle, endAngle, r0, clockWise) {
        super(x, y, r, startAngle, endAngle, r0, clockWise);
        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Sector.prototype.x
         * @description  圆心 x 坐标。
         */
        this.x = !isNaN(x) ? x : 0;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Sector.prototype.Y
         * @description  圆心 Y 坐标。
         */
        this.y = !isNaN(y) ? y : 0;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Sector.prototype.r
         * @description  外圆半径。
         */
        this.r = !isNaN(r) ? r : 0;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Sector.prototype.startAngle
         * @description  起始角度。取值范围[0, 360)，默认值：null。
         */
        this.startAngle = !isNaN(startAngle) ? startAngle : 0;

        /**
         * @member {number} Ekmap.Feature.ShapeParameters.Sector.prototype.endAngle
         * @description  结束角度。取值范围(0, 360]，默认值：null。
         */
        this.endAngle = !isNaN(endAngle) ? endAngle : 0;

        /**
         * @member {number} [Ekmap.Feature.ShapeParameters.Sector.prototype.r0=0]
         * @description 内圆半径，指定后将出现内弧，同时扇边长度为 r 减 r0。取值范围[0, r)。
         */
        this.r0 = !isNaN(r0) ? r0 : 0;

        /**
         * @member {number} [Ekmap.Feature.ShapeParameters.Sector.prototype.clockWise=false]
    ...
    /**
     * @function Ekmap.Feature.ShapeParameters.Sector.prototype.destroy
     * @description 销毁对象。
     */
    destroy() {
        this.x = null;
...
/**
 * @typedef {Object} Ekmap.Feature.ShapeParameters.Sector.style
