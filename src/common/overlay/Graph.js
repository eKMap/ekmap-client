...
/**
 * @class Ekmap.Feature.Theme.Graph
 * @classdesc 统计专题要素基类。
 * @category Visualization Theme
 * @description 此类定义了统计专题要素基础模型，具体的图表模型通过继承此类，在子类中实现 assembleShapes 方法。
 *              统计专题要素模型采用了可视化图形大小自适应策略，用较少的参数控制着图表诸多图形，图表配置对象 <Ekmap.Feature.Theme.Graph.setting> 的基础属性只有 7 个，
 ...
 * @param {Ekmap.Layer.Theme} layer - 此专题要素所在图层。
...
export class Graph extends Theme {
    ...
    constructor(data, layer, fields, setting, lonlat, options) {
         ...
         * @description 当前图形参数对象，<Ekmap.Feature.ShapeParameters> 的子类对象。
         */
        ...
        /**
         * @readonly
         * @member {Array.<string>} Ekmap.Feature.Theme.Graph.prototype.fields 
         * @description 数据{Ekmap.Feature.Vector}属性字段。
         */
        this.fields = fields || [];

        /**
         * @readonly
         * @member {Array.<number>} Ekmap.Feature.Theme.Graph.prototype.dataValues
    ...
    /**
     * @function Ekmap.Feature.Theme.Graph.prototype.destroy
     * @description 销毁专题要素。
     */
    destroy() {
    ...
    /**
     * @function Ekmap.Feature.Theme.Graph.prototype.initBaseParameter
    ...
    /**
     * @function Ekmap.Feature.Theme.Graph.prototype.resetLocation
     * @description 根据地理位置 lonlat 重置专题要素（图表）位置。
     * @param {Ekmap.LonLat} lonlat - 专题要素新的像素中心位置。
    ...
    /**
     * @function Ekmap.Feature.Theme.Graph.prototype.resetLinearGradient
    ...
    /**
     * @function Ekmap.Feature.Theme.Graph.prototype.shapesConvertToRelativeCoordinate
    ...
    /**
     * @function Ekmap.Feature.Theme.Graph.prototype.assembleShapes
     ...
     *    var barParams = new Ekmap.Feature.ShapeParameters.Polygon(poiLists);
    ...
    /**
     * @function Ekmap.Feature.Theme.Graph.prototype.getLocalXY
     * @description 地理坐标转为像素坐标。
     * @param {Ekmap.Lonlat} lonlat - 带转换的地理坐标。
     * @returns 屏幕像素坐标。
     */
    getLocalXY(lonlat) {
...
/**
 * @function Ekmap.Feature.Theme.getDataValues
 * @description 根据字段名数组获取指定数据（feature）的属性值数组。属性值类型必须为 Number。
 * @param {Ekmap.Feature.Vector} data - 数据。
