...
/**
 * @class Ekmap.Feature.Theme.Point
 * @classdesc 点状图。
...
export class Point extends Graph {
    ...
    /**
     * @function Ekmap.Feature.Theme.Point.prototype.destroy
    ...
    /**
     * @function Ekmap.Feature.Theme.prototype.Point.assembleShapes
    ...
    /**
     * @function Ekmap.Feature.Theme.Point.prototype.calculateXShapeInfo
...
/**
 * @typedef {Object} Ekmap.Feature.Theme.Point.setting
 ...
 * @property {Ekmap.Feature.ShapeParameters.Point.style} [pointStyle] - 点状图中图形点基础 style，此参数控制图形点基础样式，优先级低于 pointStyleByFields 和 pointStyleByCodomain。
 * @property {Array.<Ekmap.Feature.ShapeParameters.Point.style>} [pointStyleByFields] - 按专题字段 themeFields（<Ekmap.Layer.Graph.themeFields>）为图形点赋 style，此参数按字段控制图形点样式，
 *               优先级低于 pointStyleByCodomain，高于 pointStyle。此数组中的元素是样式对象。
 *               此参数中的 style 与 themeFields 中的字段一一对应 。例如： themeFields（<Ekmap.Layer.Graph.themeFields>） 为 ["POP_1992", "POP_1995", "POP_1999"],
