...
/**
 * @class Ekmap.Feature.Theme.RankSymbol
 * @classdesc 符号专题要素基类。
 * @category Visualization Theme
 * @description 此类定义了符号专题要素基础模型，具体的图表模型通过继承此类，在子类中实现 assembleShapes 方法。
 * 符号专题要素模型采用了可视化图形大小自适应策略，用较少的参数控制着图表诸多图形，图表配置对象 <Ekmap.Feature.Theme.RankSymbol.setting> 的基础属性只有 5 个，
...
export class RankSymbol extends Graph {
    ...
    constructor(data, layer, fields, setting, lonlat, options) {
        ...
        /**
         * @member Ekmap.Feature.Theme.RankSymbol.prototype.setting -{Object}
    ...
    /**
     * @function Ekmap.Feature.Theme.RankSymbol.prototype.destroy
     * @description 销毁专题要素。
     */
    destroy() {
        this.setting = null;
    ...
    /**
     * @function Ekmap.Feature.Theme.RankSymbol.prototype.initBaseParameter
