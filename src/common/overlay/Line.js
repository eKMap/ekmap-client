...
/**
 * @class Ekmap.Feature.Theme.Line
 * @classdesc 折线图。
 ...
 * // start: 值域值下限（包含）;
 * // end: 值域值上限（不包含）;
 * // style: 数据可视化图形的 style，这个样式对象的可设属性： <Ekmap.Feature.ShapeParameters.Point.style> 。
 ...
 * @param {Ekmap.Feature.Theme.Line.setting} setting - 图表配置对象。
...
export class Line extends Graph {
    ...
    /**
     * @function Ekmap.Feature.Theme.Line.prototype.assembleShapes
    ...
    /**
     * @function Ekmap.Feature.Theme.Line.prototype.calculateXShapeInfo
...
/**
 * @typedef {Object} Ekmap.Feature.Theme.Line.setting
 ...
 * @property {Ekmap.Feature.ShapeParameters.Line.style} [lineStyle] - 折线图中折线 style。
 * @property {Ekmap.Feature.ShapeParameters.Point.style} [pointStyle] - 折线图中折线节点基础 style，此参数控制折线节点基础样式，优先级低于 pointStyleByFields 和 pointStyleByCodomain。
 * @property {Ekmap.Feature.ShapeParameters.Point.style} [pointStyleByFields] - 按专题字段 themeFields（<Ekmap.Layer.Graph.themeFields>）为折线节点赋 style，此参数按字段控制折线节点样式，
 *                       优先级低于 pointStyleByCodomain，高于 pointStyle。此数组中的元素是样式对象。
 *                       此参数中的 style 与 themeFields 中的字段一一对应 。例如： themeFields（<Ekmap.Layer.Graph.themeFields|L.Ekmap.graphThemeLayer.themeFields|ol.source.Graph.themeFields|mapboxgl.Ekmap.GraphThemeLayer.themeFields>） 为 ["POP_1992", "POP_1995", "POP_1999"],
