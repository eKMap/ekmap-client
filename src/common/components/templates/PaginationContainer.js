...
/**
 * @class Ekmap.Components.PaginationContainer
 * @classdesc 分页组件模板。
 * @version 9.1.1
...
export class PaginationContainer extends TemplateBase {
    ...
    /**
     * @function Ekmap.Components.PaginationContainer.prototype.setLinkageEvent
    ...
    /**---------以下是页面相关操作 **/
    /**
     * @function Ekmap.Components.PaginationContainer.prototype.setContent
     * @description 设置页面内容。
    ...
    /**
     * @function Ekmap.Components.PaginationContainer.prototype.appendContent
     * @description 追加内容。
     * @param {Element} element - 页面内容元素。
     */
    ...
    /**
     * @function Ekmap.Components.PaginationContainer.prototype.clearContent
     * @description 清空内容元素。
     */
    clearContent() {
    ...
    /** -----以下是页码相关的操作：**/
    /**
     * @function Ekmap.Components.PaginationContainer.prototype.setPageLink
     * @description 设置页码数。
    ...
    /**
     * @function Ekmap.Components.PaginationContainer.prototype.clearPageLink
     * @description 清除页码列表。
     */
    clearPageLink() {
...
Ekmap.Components.PaginationContainer = PaginationContainer;