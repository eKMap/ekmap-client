...
export class LayerStatus {
    ...
    constructor(options) {
        /**
         * @member {string} Ekmap.LayerStatus.prototype.layerName
         * @description 获取或设置图层名称。
         */
        this.layerName = null;

        /**
         * @member {boolean} Ekmap.LayerStatus.prototype.isVisible
         * @description 获取或设置图层是否可见，true 表示可见。
         */
        this.isVisible = null;

        /**
         * @member {string} [Ekmap.LayerStatus.prototype.displayFilter]
         * @description 图层显示 SQL 过滤条件，如 layerStatus.displayFilter = "smid < 10"，表示仅显示 smid 值小于 10 的对象。
         */
        this.displayFilter = null;

        /**
         * @member {Object} [Ekmap.LayerStatus.prototype.fieldValuesDisplayFilter]
        ...
        this.CLASS_NAME = "Ekmap.LayerStatus";
    }

    /**
     * @function Ekmap.LayerStatus.prototype.destroy
    ...
    /**
     * @function Ekmap.LayerStatus.prototype.toJSON
