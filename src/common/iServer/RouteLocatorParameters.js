...
/**
 * @class Ekmap.RouteLocatorParameters
 ...
 * @param {(Ekmap.Route|L.Polyline|ol.geom.LineString)} options.sourceRoute - 路由对象。
...
export class RouteLocatorParameters {
    ...
    constructor(options) {
        ...
        /**
         * @member {(Ekmap.Route|L.Polyline|ol.geom.LineString)} Ekmap.RouteLocatorParameters.prototype.sourceRoute
         * @description 路由对象。
         */
        this.sourceRoute = null;

        /**
         * @member {string} Ekmap.RouteLocatorParameters.prototype.dataset
         * @description 要用来做缓冲区分析的数据源中数据集的名称。该名称用形如"数据集名称@数据源别名"形式来表示。
         */
        this.dataset = null;

        /**
         * @member {string} Ekmap.RouteLocatorParameters.prototype.routeIDField
        ...
        /**
         * @member {number} Ekmap.RouteLocatorParameters.prototype.routeID
         * @description 路由对象标识。
         *
         */
        this.routeID = null;
        ...
        /**
         * @member {string} [Ekmap.RouteLocatorParameters.prototype.type]
        ...
        /**
         * @member {float} Ekmap.RouteLocatorParameters.prototype.measure
         * @description 定位点的 M 值。只当路由对象定位点时有意义。
         */
        this.measure = null;

        /**
         * @member {float} [Ekmap.RouteLocatorParameters.prototype.offset=0]
         * @description 定位点偏移量。只当路由对象定位点时有意义。
         */
        this.offset = 0;

        /**
         * @member {boolean} [Ekmap.RouteLocatorParameters.prototype.isIgnoreGap=false]
         * @description 是否忽略子对象之间的距离。
         */
        this.isIgnoreGap = false;

        /**
         *  @member {float} [Ekmap.RouteLocatorParameters.prototype.startMeasure]
         *  @description 定位线的起始 M 值。只当路由对象定位线时有意义。
         */
        this.startMeasure = null;

        /**
         *  @member {float} [Ekmap.RouteLocatorParameters.prototype.endMeasure]
        ...
        this.CLASS_NAME = "Ekmap.RouteLocatorParameters";
    }


    /**
     * @function Ekmap.RouteLocatorParameters.prototype.destroy
...
Ekmap.RouteLocatorParameters = RouteLocatorParameters;