...
/**
 * @class Ekmap.InterpolationAnalystParameters
 ...
 * @param {Array.<Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point>} [options.inputPoints] - 用于做插值分析的离散点集合。当插值分析类型（InterpolationAnalystType）为 geometry 时，此参数为必设参数。 
 ...
 * @param {Ekmap.PixelFormat} [options.pixelFormat] - 指定结果栅格数据集存储的像素格式。 
...
export class InterpolationAnalystParameters {
    ...
    constructor(options) {
        ...
        /**
         * @member {(Ekmap.Bounds|L.Bounds|ol.extent)} Ekmap.InterpolationAnalystParameters.prototype.bounds
        ...
        /**
         * @member {number} [Ekmap.InterpolationAnalystParameters.prototype.searchRadius=0]
        ...
        /**
         * @member {string} Ekmap.InterpolationAnalystParameters.prototype.zValueFieldName
        ...
        /**
         * @member {number} [Ekmap.InterpolationAnalystParameters.prototype.zValueScale=1]
        ...
        /**
         * @member {number} Ekmap.InterpolationAnalystParameters.prototype.resolution
        ...
        /**
         * @member {Ekmap.FilterParameter} [Ekmap.InterpolationAnalystParameters.prototype.filterQueryParameter]
         * @description 过滤条件，对分析数据集中的点进行过滤，设置为 null 表示对数据集中的所有点进行分析。
         */
        this.filterQueryParameter = null;

        /**
         * @member {string} Ekmap.InterpolationAnalystParameters.prototype.outputDatasetName
         * @description 插值分析结果数据集的名称。 
         */
        this.outputDatasetName = null;

        /**
         * @member {string} Ekmap.InterpolationAnalystParameters.prototype.outputDatasourceName
         * @description 插值分析结果数据源的名称。 
         */
        this.outputDatasourceName = null;

        /**
         * @member {Ekmap.PixelFormat} [Ekmap.InterpolationAnalystParameters.prototype.pixelFormat]
         * @description 指定结果栅格数据集存储的像素格式。支持存储的像素格式有 BIT16、BIT32、DOUBLE、SINGLE、UBIT1、UBIT4、UBIT8、UBIT24、UBIT32。
         */
        this.pixelFormat = null;

        /**
         * @member {string} [Ekmap.InterpolationAnalystParameters.prototype.dataset]
        ...
        /**
         * @member {Array.<Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point>} [Ekmap.InterpolationAnalystParameters.prototype.inputPoints]
        ...
        /**
         * @member {string} [Ekmap.InterpolationAnalystParameters.prototype.InterpolationAnalystType="dataset"]
        ...
        /**
         * @member {Object} Ekmap.InterpolationAnalystParameters.prototype.clipParam
         * @description 对插值分析结果进行裁剪的参数。
         */
        this.clipParam = null;

        Util.extend(this, options);
        this.CLASS_NAME = "Ekmap.InterpolationAnalystParameters";
    }

    /**
     * @function Ekmap.InterpolationAnalystParameters.prototype.destroy
    ...
    /**
     * @function Ekmap.InterpolationAnalystParameters.toObject
     * @param {Ekmap.InterpolationAnalystParameters} interpolationAnalystParameters - 插值分析参数类。
     * @param {Ekmap.InterpolationAnalystParameters} tempObj - 插值分析参数对象。
...
Ekmap.InterpolationAnalystParameters = InterpolationAnalystParameters;