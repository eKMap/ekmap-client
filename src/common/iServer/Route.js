 ...
 * @param {Array.<Ekmap.Geometry>} points - 形成路由对象的线数组。
 ...
 * @extends {Ekmap.Geometry.Collection}
 */
export class Route extends Collection {
    ...
    constructor(points, options) {
        ...
        /**
         * @member {number} Ekmap.Route.prototype.id
         * @description 路由对象在数据库中的 ID。
         */
        this.id = null;

        /**
         * @member {number} Ekmap.Route.prototype.center
         * @description 路由对象的中心点。
         */
        this.center = null;

        /**
         * @member {string} Ekmap.Route.prototype.style
         * @description 路由对象的样式。
         */
        this.style = null;

        /**
         * @member {number} Ekmap.Route.prototype.length
         * @description 路由对象的长度。单位与数据集的单位相同。
         */
        this.length = null;

        /**
         *  @member {number} Ekmap.Route.prototype.maxM
         *  @description 最大线性度量值，即所有结点到起始点的量算距离中最大值。
         */
        this.maxM = null;

        /**
         * @member {number} Ekmap.Route.prototype.minM
         * @description 最小线性度量值，即所有结点到起始点的量算距离中最小值。
         */
        this.minM = null;

        /**
         * @member {Array.<number>} Ekmap.Route.prototype.parts
         * @description 服务端几何对象中各个子对象所包含的节点个数。
         */
        this.parts = null;

        /**
         * @member {Array.<Object>} Ekmap.Route.prototype.points
        ...
        /**
         * @member {string} Ekmap.Route.prototype.type
         * @description 服务端几何对象类型。
         */
        this.type = null;

        /**
         * @member {Array.<string>} [Ekmap.Route.prototype.componentTypes=Ekmap.Geometry.LineString]
         * @description components 存储的的几何对象所支持的几何类型数组。
         */
        this.componentTypes = ["Ekmap.Geometry.LinearRing", "Ekmap.Geometry.LineString"];

        if (options) {
            Util.extend(this, options);
        }

        this.CLASS_NAME = "Ekmap.Route";
        this.geometryType = "LINEM";
    }

    /**
     *
     * @function Ekmap.Route.prototype.toJson
    ...
    /**
     * @function Ekmap.Route.prototype.destroy
     * @override
     */
    destroy() {
        var me = this;
    ...
    /**
     * @function Ekmap.Route.fromJson
     * @description 将 JSON 对象转换为 Ekmap.Route 对象。
     * @param {Object} [jsonObject] - JSON 对象表示的路由对象。
     * @returns {Ekmap.Route} 转化后的 Route 对象。
     */
