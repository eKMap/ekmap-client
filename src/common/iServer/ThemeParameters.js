 ...
 * @param {Array.<Ekmap.JoinItem>} [options.joinItems] - 专题图外部表的连接信息 JoinItem 数组。
 * @param {Array.<Ekmap.Theme>} options.themes - 专题图对象列表。
...
export class ThemeParameters {
    ...
    constructor(options) {
        /**
         * @member {Array.<string>} Ekmap.ThemeParameters.prototype.datasetNames
         * @description 要制作专题图的数据集数组。
         */
        this.datasetNames = null;

        /**
         * @member {Array.<string>} Ekmap.ThemeParameters.prototype.dataSourceNames
         * @description 要制作专题图的数据集所在的数据源数组。
         */
        this.dataSourceNames = null;

        /**
         * @member {Array.<Ekmap.JoinItem>} [Ekmap.ThemeParameters.prototype.joinItems]
        ...
        /**
         * @member {Array.<Ekmap.Theme>} Ekmap.ThemeParameters.prototype.themes
         * @description 专题图对象列表。
         *              该参数为实例化的各类专题图对象的集合。
         */
        this.themes = null;
        ...
        /**
         * @member {Array.<string>} [Ekmap.ThemeParameters.prototype.displayFilters]
         * @description 专题图属性过滤条件。
         */
        this.displayFilters = null;

        /**
         * @member {Array.<string>}  [Ekmap.ThemeParameters.prototype.displayOrderBys]
         * @description 专题图对象生成符号叠加次序排序字段。
         */
        this.displayOrderBys = null;

        /**
         * @member {Object} [Ekmap.ThemeParameters.prototype.fieldValuesDisplayFilter]
        ...
        this.CLASS_NAME = "Ekmap.ThemeParameters";
    }


    /**
     * @function Ekmap.ThemeParameters.prototype.destroy
...
Ekmap.ThemeParameters = ThemeParameters;