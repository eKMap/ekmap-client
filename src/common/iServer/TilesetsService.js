...
export class TilesetsService extends CommonServiceBase {
    ...
    constructor(url, options) {
        super(url, options);
        this.CLASS_NAME = "Ekmap.TilesetsService";
    }
    ...
    /**
     * @function Ekmap.TilesetsService.prototype.processAsync
...
Ekmap.TilesetsService = TilesetsService;