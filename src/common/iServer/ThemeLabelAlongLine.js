...
/**
 * @class Ekmap.ThemeLabelAlongLine
 * @category  iServer Map Theme
 * @classdesc 标签沿线标注样式类。
 * @param {Object} options - 参数。
 * @param {boolean} [options.isAlongLine=true] - 是否沿线显示文本。
 * @param {Ekmap.AlongLineDirection} [options.alongLineDirection=Ekmap.AlongLineDirection.LB_TO_RT] - 标签沿线标注方向。
...
export class ThemeLabelAlongLine {
    ...
    constructor(options) {
        /**
         * @member {boolean} [Ekmap.ThemeLabelAlongLine.prototype.isAlongLine=true]
         * @description 是否沿线显示文本。true 表示沿线显示文本，false 表示正常显示文本。
         */
        this.isAlongLine = true;

        /**
         * @member {Ekmap.AlongLineDirection} [Ekmap.ThemeLabelAlongLine.prototype.alongLineDirection=Ekmap.AlongLineDirection.LB_TO_RT]
         * @description 标签沿线标注方向。
         */
        this.alongLineDirection = AlongLineDirection.LB_TO_RT;

        /**
         * @member {boolean} [Ekmap.ThemeLabelAlongLine.prototype.angleFixed=false]
        ...
        /**
         * @member {boolean} Ekmap.ThemeLabelAlongLine.prototype.repeatedLabelAvoided
         * @description 沿线循环标注时是否避免标签重复标注。
         */
        this.repeatedLabelAvoided = false;

        /**
         * @member {boolean} [Ekmap.ThemeLabelAlongLine.prototype.repeatIntervalFixed=false]
        ...
        /**
         * @member {number} [Ekmap.ThemeLabelAlongLine.prototype.labelRepeatInterval=0]
        ...
        this.CLASS_NAME = "Ekmap.ThemeLabelAlongLine";
    }


    /**
     * @function Ekmap.ThemeLabelAlongLine.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeLabelAlongLine.fromObj
     * @description 从传入对象获取标签沿线标注样式类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeLabelAlongLine} ThemeLabelAlongLine 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
...
Ekmap.ThemeLabelAlongLine = ThemeLabelAlongLine;