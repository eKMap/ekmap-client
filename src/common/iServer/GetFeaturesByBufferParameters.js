...
/**
 * @class Ekmap.GetFeaturesByBufferParameters
...
export class GetFeaturesByBufferParameters extends GetFeaturesParametersBase {
    ...
    constructor(options) {
        super(options);
        /**
         * @member {number} Ekmap.GetFeaturesByBufferParameters.prototype.bufferDistance
         * @description buffer 距离,单位与所查询图层对应的数据集单位相同。
         */
        this.bufferDistance = null;

        /**
         * @member {string} Ekmap.GetFeaturesByBufferParameters.prototype.attributeFilter
         * @description 属性查询条件。
         */
        this.attributeFilter = null;

        /**
         * @member {Object} Ekmap.GetFeaturesByBufferParameters.prototype.geometry
        ...
        /**
         * @member {Array.<string>} Ekmap.GetFeaturesByBufferParameters.prototype.fields
         * @description 设置查询结果返回字段。当指定了返回结果字段后，则 GetFeaturesResult 中的 features 的属性字段只包含所指定的字段。不设置即返回全部字段。
         */
        this.fields = null;
        Util.extend(this, options);
        this.CLASS_NAME = "Ekmap.GetFeaturesByBufferParameters";
    }


    /**
     * @function Ekmap.GetFeaturesByBufferParameters.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.GetFeaturesByBufferParameters.toJsonParameters
     * @description 将 Ekmap.GetFeaturesByBufferParameters 对象转换为 JSON 字符串。
     * @param {Ekmap.GetFeaturesByBufferParameters} params - 数据集缓冲区查询参数对象。
...
Ekmap.GetFeaturesByBufferParameters = GetFeaturesByBufferParameters;