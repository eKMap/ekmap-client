 ...
 * @param {Ekmap.ServerStyle} options.style - 分段专题图子项的风格。
...
export class ThemeRangeItem {
    ...
    constructor(options) {
        /**
         * @member {string} [Ekmap.ThemeRangeItem.prototype.caption]
         * @description 分段专题图子项的标题。
         */
        this.caption = null;

        /**
         * @member {number} [Ekmap.ThemeRangeItem.prototype.end=0]
        ...
        /**
         * @member {number} [Ekmap.ThemeRangeItem.prototype.start=0]
        ...
        /**
         * @member {Ekmap.ServerStyle} Ekmap.ThemeRangeItem.prototype.style
        ...
        /**
         * @member {boolean} [Ekmap.ThemeRangeItem.prototype.visible=true]
        ...
        this.CLASS_NAME = "Ekmap.ThemeRangeItem";
    }

    /**
     * @function Ekmap.ThemeRangeItem.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeRangeItem.prototypetoServerJSONObject
    ...
    /**
     * @function Ekmap.ThemeRangeItem.fromObj
     * @description 从传入对象获取范围分段专题图子项类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeRangeItem} ThemeRangeItem 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
...
Ekmap.ThemeRangeItem = ThemeRangeItem;