...
/**
 * @class Ekmap.InterpolationRBFAnalystParameters
 ...
 * @param {Array.<Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point>} [options.inputPoints] - 用于做插值分析的离散点集合。当插值分析类型（InterpolationAnalystType）为 geometry 时。此参数为必选。
 * @example
 * var myInterpolationRBFAnalystParameters = new Ekmap.InterpolationRBFAnalystParameters({
...
export class InterpolationRBFAnalystParameters extends InterpolationAnalystParameters {
    ...
    constructor(options) {
        super(options);
        /**
         * @member {number} [Ekmap.InterpolationRBFAnalystParameters.prototype.smooth=0.1]
        ...
        /**
         * @member {number} [Ekmap.InterpolationRBFAnalystParameters.prototype.tension=40]
        ...
        /**
         * @member {Ekmap.SearchMode} Ekmap.InterpolationRBFAnalystParameters.prototype.searchMode
        ...
        /**
         * @member {number} [Ekmap.InterpolationRBFAnalystParameters.prototype.expectedCount=12]
         * @description 【固定点数查找】方式下，设置待查找的点数，即参与差值运算的点数。
         */
        this.expectedCount = 12;

        /**
         * @member {number} [Ekmap.InterpolationRBFAnalystParameters.prototype.maxPointCountForInterpolation=200]
         * @description 【块查找】方式下，最多参与插值的点数。
         */
        this.maxPointCountForInterpolation = 200;

        /**
         * @member {number} [Ekmap.InterpolationRBFAnalystParameters.prototype.maxPointCountInNode=50]
        ...
        this.CLASS_NAME = "Ekmap.InterpolationRBFAnalystParameters";

    }


    /**
     * @function Ekmap.InterpolationRBFAnalystParameters.prototype.destroy
    ...
    /**
     * @function Ekmap.InterpolationRBFAnalystParameters.toObject
     * @param {Ekmap.InterpolationRBFAnalystParameters} datasetInterpolationRBFAnalystParameters - 样条插值（径向基函数插值法）分析参数类
     * @param {Ekmap.InterpolationRBFAnalystParameters} tempObj - 样条插值（径向基函数插值法）分析参数对象
...
Ekmap.InterpolationRBFAnalystParameters = InterpolationRBFAnalystParameters;