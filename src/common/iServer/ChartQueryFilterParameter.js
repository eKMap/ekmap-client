...
/**
 * @class Ekmap.ChartQueryFilterParameter
...
export class ChartQueryFilterParameter {
    ...
    constructor(options) {
        /**
         * @member {boolean} [Ekmap.ChartQueryFilterParameter.prototype.isQueryPoint]
         * @description 是否查询点。
         */
        this.isQueryPoint = null;

        /**
         * @member {boolean} [Ekmap.ChartQueryFilterParameter.prototype.isQueryLine]
         * @description 是否查询线。
         */
        this.isQueryLine = null;

        /**
         * @member {boolean} [Ekmap.ChartQueryFilterParameter.prototype.isQueryRegion]
         * @description 是否查询面。
         */
        this.isQueryRegion = null;

        /**
         * @member {string} Ekmap.ChartQueryFilterParameter.prototype.attributeFilter
         * @description 属性字段过滤条件。
         */
        this.attributeFilter = null;

        /**
         * @member {number} Ekmap.ChartQueryFilterParameter.prototype.chartFeatureInfoSpecCode
         * @description 查询的物标代号。
         */
        ...
        this.CLASS_NAME = "Ekmap.ChartQueryFilterParameter";
    }

    /**
     * @function Ekmap.ChartQueryFilterParameter.prototype.destroy
    ...
    /**
     * @function Ekmap.ChartQueryFilterParameter.prototype.toJson
...
Ekmap.ChartQueryFilterParameter = ChartQueryFilterParameter;