...
/**
 * @class Ekmap.FindTSPPathsParameters
...
export class FindTSPPathsParameters {
    ...
    constructor(options) {
        /**
         * @member {boolean} [Ekmap.FindTSPPathsParameters.prototype.endNodeAssigned=false]
        ...
        /**
         * @member {boolean} [Ekmap.FindTSPPathsParameters.prototype.isAnalyzeById=false]
         * @description 是否通过节点 ID 号来指定途经点。
         */
        this.isAnalyzeById = false;

        /**
         * @member {Array.<Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point|number>} Ekmap.FindTSPPathsParameters.prototype.nodes
         * @description 旅行商分析途经点数组。
         *              当 Ekmap.FindTSPPathsParameters.isAnalyzeById = false 时，nodes 应为点的坐标数组；
         *              当 Ekmap.FindTSPPathsParameters.isAnalyzeById = true 时，nodes 应为点的 ID 数组。
         */
        this.nodes = null;

        /**
         * @member {Ekmap.TransportationAnalystParameter} [Ekmap.FindTSPPathsParameters.prototype.parameter]
         * @description 交通网络分析通用参数。通过本类可以设置障碍边、障碍点、权值字段信息的名称标识、转向权值字段等信息。
         *              Ekmap.TransportationAnalystParameter 类型，它虽然为可选参数，但是如果不设置其中的 resultSetting
         *              字段，则返回结果空间信息等都为空。
         */
        this.parameter = new TransportationAnalystParameter();
        Util.extend(this, options);

        this.CLASS_NAME = "Ekmap.FindTSPPathsParameters";
    }

    /**
     * @function Ekmap.FindTSPPathsParameters.prototype.destroy
...
Ekmap.FindTSPPathsParameters = FindTSPPathsParameters;