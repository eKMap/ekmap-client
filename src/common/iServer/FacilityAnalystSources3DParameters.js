...
/**
 * @class Ekmap.FacilityAnalystSources3DParameters
...
export class FacilityAnalystSources3DParameters extends FacilityAnalyst3DParameters {
    ...
    constructor(options) {
        super(options);
        this.CLASS_NAME = "Ekmap.FacilityAnalystSources3DParameters";
    }

    /**
     * @function Ekmap.FacilityAnalystSources3DParameters.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
...
Ekmap.FacilityAnalystSources3DParameters = FacilityAnalystSources3DParameters;