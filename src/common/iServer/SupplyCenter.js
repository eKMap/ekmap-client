 ...
 * @param {Ekmap.SupplyCenterType} [options.type] - 资源供给中心点的类型常量。
 */
export class SupplyCenter {

    constructor(options) {
        /**
         * @member {number} Ekmap.SupplyCenter.prototype.maxWeight
        ...
        /**
         * @member {number} Ekmap.SupplyCenter.prototype.nodeID
         * @description 资源供给中心点的结点 ID 号，资源供给中心必须是结点。
         */
        this.nodeID = null;

        /**
         * @member {number} Ekmap.SupplyCenter.prototype.resourceValue
         * @description 资源供给中心能提供的最大服务量或商品数量。例如资源中心为学校，资源中心资源量表示该学校能够接纳多少学生。
         */
        this.resourceValue = null;

        /**
         * @member {Ekmap.SupplyCenterType} [Ekmap.SupplyCenter.prototype.type]
        ...
        this.CLASS_NAME = "Ekmap.SupplyCenter";
    }

    /**
     * @function Ekmap.SupplyCenter.prototype.destroy
    ...
    /**
     * @function Ekmap.SupplyCenter.fromJson
     * @description 将服务端 JSON 对象转换成当前客户端对象。
     * @param {Object} jsonObject - 要转换的 JSON 对象。
     * @returns {Ekmap.SupplyCenter} SupplyCenter 对象。
     */
...
Ekmap.SupplyCenter = SupplyCenter;