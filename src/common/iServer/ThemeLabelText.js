 ...
 * @param {Ekmap.ServerTextStyle} [options.uniformStyle] - 统一文本风格。
 * @param {Ekmap.LabelMixedTextStyle} [options.uniformMixedStyle] - 标签专题图统一的文本复合风格。
 */
export class ThemeLabelText {

    constructor(options) {
        /**
         * @member {number} [Ekmap.ThemeLabelText.prototype.maxTextHeight=0]
         * @description 标签中文本的最大高度。当标签文本不固定大小时，即 Ekmap.ServerTextStyle.sizeFixed = false 有效，
         *              当放大后的文本高度超过最大高度之后就不再放大。高度单位为 0.1 毫米。
         */
        this.maxTextHeight = 0;

        /**
         * @member {number} [Ekmap.ThemeLabelText.prototype.maxTextWidth=0]
         * @description 标签中文本的最大宽度。当标签文本不固定大小时，即 Ekmap.ServerTextStyle.sizeFixed = false 有效，
         *              当放大后的文本宽度超过最大高度之后就不再放大。宽度单位为 0.1 毫米。
         */
        this.maxTextWidth = 0;

        /**
         * @member {number} [Ekmap.ThemeLabelText.prototype.minTextHeight=0]
         * @description 标签中文本的最小高度。当标签文本不固定大小时，即 Ekmap.ServerTextStyle.sizeFixed = false 有效，
         *              当缩小后的文本高度小于最小高度之后就不再缩小。高度单位为 0.1 毫米。
         */
        this.minTextHeight = 0;

        /**
         * @member {number} [Ekmap.ThemeLabelText.prototype.minTextWidth=0]
         * @description 标签中文本的最小宽度。当标签文本不固定大小时，即 Ekmap.ServerTextStyle.sizeFixed = false 有效，
         *              当缩小后的文本宽度小于最小宽度之后就不再缩小。宽度单位为 0.1 毫米。
         */
        this.minTextWidth = 0;

        /**
         * @member {Ekmap.ServerTextStyle} [Ekmap.ThemeLabelText.prototype.uniformStyle]
         * @description 统一文本风格。当标签专题图子项的个数大于等于1时，
         *              uniformStyle 不起作用，各标签的风格使用子项中设置的风格。各种风格的优先级从高到低为：uniformMixedStyle（标签文本的复合风格），
         *              Ekmap.ThemeLabelItem.style（分段子项的文本风格），uniformStyle（统一文本风格）。
         */
        this.uniformStyle = new ServerTextStyle();

        /**
         *@member {Ekmap.LabelMixedTextStyle} [Ekmap.ThemeLabelText.prototype.uniformMixedStyle]
        ...
        this.CLASS_NAME = "Ekmap.ThemeLabelText";
    }

    /**
     * @function Ekmap.ThemeLabelText.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeLabelText.fromObj
     * @description 从传入对象获取标签中文本风格类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeLabelText} ThemeLabelText 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
...
Ekmap.ThemeLabelText = ThemeLabelText;