...
/**
 * @class Ekmap.TerrainCurvatureCalculationParameters
...
export class TerrainCurvatureCalculationParameters {
    ...
    constructor(options) {
        ...
        /**
         * @member {string} Ekmap.TerrainCurvatureCalculationParameters.prototype.dataset
        ...
        /**
         * @member {number} [Ekmap.TerrainCurvatureCalculationParameters.prototype.zFactor=1.0]
        ...
        /**
         * @member {string} Ekmap.TerrainCurvatureCalculationParameters.prototype.averageCurvatureName
         * @description 结果数据集：平均曲率数据集的名称。
         */
        this.averageCurvatureName = null;

        /**
         * @member {string} Ekmap.TerrainCurvatureCalculationParameters.prototype.profileCurvatureName
         * @description 结果数据集：剖面曲率数据集的名称。
         */
        this.profileCurvatureName = "";

        /**
         * @member {string} Ekmap.TerrainCurvatureCalculationParameters.prototype.planCurvatureName
         * @description 结果数据集：平面曲率数据集的名称。
         */
        this.planCurvatureName = "";

        /**
         * @member {boolean} [Ekmap.TerrainCurvatureCalculationParameters.prototype.deleteExistResultDataset=false]
        ...
        this.CLASS_NAME = "Ekmap.TerrainCurvatureCalculationParameters";
    }


    /**
     * @function Ekmap.TerrainCurvatureCalculationParameters.prototype.destroy
    ...
    /**
     * @function Ekmap.TerrainCurvatureCalculationParameters.toObject
...
Ekmap.TerrainCurvatureCalculationParameters = TerrainCurvatureCalculationParameters;