 ...
 * @param {Array.<Ekmap.ThemeRangeItem>} options.items - 分段专题图子项数组。
...
export class ThemeRange extends Theme {
    ...
    constructor(options) {
        super("RANGE", options);
        /**
         * @member {string} Ekmap.ThemeRange.prototype.precision
         * @description 精准度
         */
        this.precision = '1.0E-12';

        /**
         * @member {Array.<Ekmap.ThemeRangeItem>} Ekmap.ThemeRange.prototype.items
        ...
        /**
         * @member {string} Ekmap.ThemeRange.prototype.rangeExpression
        ...
        /**
         * @member {Ekmap.RangeMode} [Ekmap.ThemeRange.prototype.rangeMode=Ekmap.RangeMode.EQUALINTERVAL]
        ...
        /**
         * @member {number} Ekmap.ThemeRange.prototype.rangeParameter
         * @description 分段参数。
        ...
        /**
         * @member {Ekmap.ColorGradientType} [Ekmap.ThemeRange.prototype.colorGradientType=Ekmap.ColorGradientType.YELLOW_RED]
         * @description 渐变颜色枚举类。<br>
         *              渐变色是由起始色根据一定算法逐渐过渡到终止色的一种混合型颜色。
         *              该类作为单值专题图参数类、分段专题图参数类的属性，负责设置单值专题图、分段专题图的配色方案，在默认情况下专题图所有子项会根据这个配色
         *              方案完成填*充。但如果为某几个子项的风格进行单独设置后（设置了 {@link Ekmap.ThemeUniqueItem} 或 {@link Ekmap.ThemeRangeItem} 类中Style属性），
         *              该配色方案对于这几个子项将不起作用。
         */
        ...
        this.CLASS_NAME = "Ekmap.ThemeRange";
    }


    /**
     * @function Ekmap.ThemeRange.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.ThemeRange.fromObj
     * @description 从传入对象获取范围分段专题图类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeRange} ThemeRange 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
