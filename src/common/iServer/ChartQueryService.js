 ...
 * @param {Ekmap.DataFormat} [options.format] - 查询结果返回格式，目前支持 iServerJSON 和 GeoJSON 两种格式。参数格式为"ISERVER","GEOJSON"。
 ...
 *    });
 *
 * var chartQueryParameters = new Ekmap.ChartQueryParameters({
 ...
 *    });
 *
 * var chartQueryService = new Ekmap.ChartQueryService(url);
 *
...
export class ChartQueryService extends CommonServiceBase {
    ...
    constructor(url, options) {
        ...
        /**
         * @member {boolean} Ekmap.ChartQueryService.prototype.returnContent
         * @description 是否立即返回新创建资源的表述还是返回新资源的URI。
         */
        this.returnContent = null;

        /**
         * @member {Ekmap.DataFormat} Ekmap.ChartQueryService.prototype.format
        ...
        this.CLASS_NAME = "Ekmap.ChartQueryService";
    }


    /**
     * @function Ekmap.ChartQueryService.prototype.destroy
     * @override
     */
    destroy() {
        var me = this;
    ...
    /**
     * @function Ekmap.ChartQueryService.prototype.processAsync
     * @description 使用服务地址 URL 实例化 ChartQueryService 对象。
     * @param {Ekmap.ChartQueryParameters} params - 查询参数。
     */
    processAsync(params) {
        //todo重点需要添加代码的地方
    ...
    /**
     * @function Ekmap.ChartQueryService.prototype.serviceProcessCompleted
    ...
    /**
     * @function Ekmap.ChartQueryService.prototype.getQueryParameters
     * @description 将 JSON 对象表示的查询参数转化为 QueryParameters 对象。
     * @param {Object} params - JSON 字符串表示的查询参数。
     * @returns {Ekmap.QueryParameters} 返回查询结果
     */
...
Ekmap.ChartQueryService = ChartQueryService;