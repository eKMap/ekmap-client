...
/**
 * @class Ekmap.ThemeLabelUniqueItem
...
export class ThemeLabelUniqueItem {
    ...
    constructor(options) {
        /**
         * @member {string} [Ekmap.ThemeLabelUniqueItem.prototype.caption]
         * @description 标签专题子项的标题。
         */
        this.caption = null;

        /**
         * @member {string} Ekmap.ThemeLabelUniqueItem.prototype.unique
         * @description 单值专题图子项的值，可以为数字、字符串等。
         */
        this.unique = null;

        /**
         * @member {number} [Ekmap.ThemeLabelUniqueItem.prototype.offsetX=0]
         * @description 标签在 X 方向偏移量。
         */
        this.offsetX = 0;

        /**
         * @member {number} [Ekmap.ThemeLabelUniqueItem.prototype.offsetY=0]
         * @description 标签在 Y 方向偏移量。
         */
        this.offsetY = 0;

        /**
         * @member {boolean} [Ekmap.ThemeLabelUniqueItem.prototype.visible=true]
         * @description 标签专题图子项是否可见。如果标签专题图子项可见，则为 true，否则为 false。
         */
        this.visible = true;

        /**
         * @member {Ekmap.ServerTextStyle} Ekmap.ThemeLabelUniqueItem.prototype.style
        ...
        this.CLASS_NAME = "Ekmap.ThemeLabelUniqueItem";
    }

    /**
     * @function Ekmap.ThemeLabelUniqueItem.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeLabelUniqueItem.fromObj
     * @description 从传入对象获取单值标签专题图的子项类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeLabelUniqueItem} ThemeLabelUniqueItem 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
...
Ekmap.ThemeLabelUniqueItem = ThemeLabelUniqueItem;