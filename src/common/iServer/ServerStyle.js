...
/**
 * @class Ekmap.ServerStyle
 * @category  iServer Map Theme
 * @classdesc 服务端矢量要素风格类。
 * @description 该类用于定义点状符号、线状符号、填充符号风格及其相关属性。
 * @param {Object} options - 参数。
 * @param {Ekmap.FillGradientMode} options.fillGradientMode - 渐变填充风格的渐变类型。
 * @param {Ekmap.ServerColor} [options.fillBackColor=[255,255,255]] - 填充背景颜色。
 * @param {boolean} [options.fillBackOpaque=false] - 背景是否不透明。
 * @param {Ekmap.ServerColor} [options.fillForeColor=[255,0,0]] - 填充颜色。
 ...
 * @param {Ekmap.ServerColor} [options.lineColor] - 矢量要素的边线颜色。默认 lineColor = new ServerColor(0, 0, 0)。
...
export class ServerStyle {
    ...
    constructor(options) {
        /**
         * @member {Ekmap.ServerColor} Ekmap.ServerStyle.prototype.fillBackColor
         * @description 填充背景颜色。当填充模式为渐变填充时，该颜色为填充终止色。
         */
        this.fillBackColor = new ServerColor(255, 255, 255);

        /**
         * @member {boolean} [Ekmap.ServerStyle.prototype.fillBackOpaque=false]
         * @description 背景是否不透明。false 表示透明。
         */
        this.fillBackOpaque = false;

        /**
         * @member {Ekmap.ServerColor} Ekmap.ServerStyle.prototype.fillForeColor
         * @description 填充颜色。当填充模式为渐变填充时，该颜色为填充起始颜色。
         */
        this.fillForeColor = new ServerColor(255, 0, 0);

        /**
         * @member {Ekmap.FillGradientMode} Ekmap.ServerStyle.prototype.fillGradientMode
         * @description 渐变填充风格的渐变类型。
         */
        this.fillGradientMode = null;

        /**
         * @member {number} Ekmap.ServerStyle.prototype.fillGradientAngle -
         * @description 渐变填充的旋转角度。单位为度，精确到 0.1 度，逆时针方向为正方向。
         */
        this.fillGradientAngle = 0;

        /**
         * @member {number} Ekmap.ServerStyle.prototype.fillGradientOffsetRatioX
        ...
        /**
         * @member {number} Ekmap.ServerStyle.prototype.fillGradientOffsetRatioY
        ...
        /**
         * @member {number} [Ekmap.ServerStyle.prototype.fillOpaqueRate=100]
        ...
        /**
         * @member {number} Ekmap.ServerStyle.prototype.fillSymbolID
         * @description 填充符号的编码。此编码用于唯一标识各普通填充风格的填充符号。
         *              关于填充符号的样式与对应的 ID 号请在 Ekmap 桌面软件中查找。
         */
        this.fillSymbolID = 0;

        /**
         * @member {Ekmap.ServerColor} Ekmap.ServerStyle.prototype.lineColor
         * @description 矢量要素的边线颜色。如果等级符号是点符号，点符号的颜色由 lineColor 控制。
         */
        this.lineColor = new ServerColor(0, 0, 0);

        /**
         * @member {number} [Ekmap.ServerStyle.prototype.lineSymbolID=0]
         * @description 线状符号的编码。此编码用于唯一标识各普通填充风格的填充符号。
         *              关于线状符号的样式与对应的 ID 号请在 Ekmap 桌面软件中查找。
         */
        this.lineSymbolID = 0;

        /**
         * @member {number} [Ekmap.ServerStyle.prototype.lineWidth=1.0]
         * @description 边线的宽度。单位为毫米，精度到 0.1。
         */
        this.lineWidth = 1;

        /**
         * @member {number} [Ekmap.ServerStyle.prototype.markerAngle=0]
         * @description 点状符号的旋转角度。以度为单位，精确到 0.1 度，逆时针方向为正方向。
         */
        this.markerAngle = 0;

        /**
         * @member {number} [Ekmap.ServerStyle.prototype.markerSize=1.0]
        ...
        /**
         * @member {number} [Ekmap.ServerStyle.prototype.markerSymbolID=-1]
        ...
        this.CLASS_NAME = "Ekmap.ServerStyle";
    }

    /**
     * @function Ekmap.ServerStyle.prototype.destroy
    ...
    /**
     * @function Ekmap.ServerStyle.prototype.toServerJSONObject
    ...
    /**
     * @function Ekmap.ServerStyle.fromJson
     * @description 将JSON对象转换为 Ekmap.ServerStyle 对象。
     * @param jsonObject - {Object} 要转换的 JSON 对象。
     * @returns {Ekmap.ServerStyle} 转化后的 Ekmap.ServerStyle 对象。
     */
