 ...
 * @param {Ekmap.ColorSpaceType} [options.colorSpaceType] - 返回影像图层的色彩显示模式。
 ...
 * @param {Ekmap.ServerColor} [options.transparentColor] - 返回背景透明色。
...
export class UGCImage extends UGCSubLayer {
    ...
    constructor(options) {
        ...
        super(options);
        /**
         * @member {number} Ekmap.Image.prototype.brightness
         * @description 影像图层的亮度。
         */
        this.brightness = null;

        /**
         * @member {Ekmap.ColorSpaceType} Ekmap.Image.prototype.colorSpaceType
         * @description 返回影像图层的色彩显示模式。
         */
        this.colorSpaceType = null;

        /**
         * @member {number} Ekmap.Image.prototype.contrast
         * @description 影像图层的对比度。
         */
        this.contrast = null;

        /**
         * @member {Array.<number>} Ekmap.Image.prototype.displayBandIndexes
         * @description 返回当前影像图层显示的波段索引。
         */
        this.displayBandIndexes = null;

        /**
         * @member {boolean} Ekmap.Image.prototype.transparent
         * @description 是否背景透明。
         */
        this.transparent = null;

        /**
         * @member {Ekmap.ServerColor} Ekmap.Image.prototype.transparentColor
         * @description 返回背景透明色。
         */
        this.transparentColor = null;

        /**
         * @member {number} Ekmap.Image.prototype.transparentColorTolerance
         * @description 背景透明色容限。
         */
        this.transparentColorTolerance = null;

        this.CLASS_NAME = "Ekmap.Image";
    }

    /**
     * @function Ekmap.Image.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.Image.prototype.fromJson
    ...
    /**
     * @function Ekmap.Image.prototype.toServerJSONObject
