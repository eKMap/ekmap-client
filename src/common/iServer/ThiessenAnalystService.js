...
/**
 * @class Ekmap.ThiessenAnalystService
 ...
 * 泰森多边形分析的参数支持两种，当参数为 {Ekmap.DatasetThiessenAnalystParameters} 类型
 * 时，执行数据集泰森多边形分析，当参数为 {Ekmap.GeometryThiessenAnalystParameters} 类型时，
 * 执行几何对象泰森多边形分析。
 ...
 * @example 例如：
 * (start code)
 * var myThiessenAnalystService = new Ekmap.ThiessenAnalystService(url, {
 *     eventListeners: {
...
export class ThiessenAnalystService extends SpatialAnalystBase {
    ...
    constructor(url, options) {
        super(url, options);
        /**
         * @member {string} Ekmap.ThiessenAnalystService.prototype.mode
         * @description 缓冲区分析类型
         */
        this.mode = null;
        if (options) {
        ...
        this.CLASS_NAME = "Ekmap.ThiessenAnalystService";
    }
    ...
    /**
     * @function Ekmap.ThiessenAnalystService.prototype.processAsync
     * @description 负责将客户端的查询参数传递到服务端。
     * @param {(Ekmap.DatasetThiessenAnalystParameters|GeometryThiessenAnalystParameters)} parameter - 泰森多边形分析参数基类。
     */
...
Ekmap.ThiessenAnalystService = ThiessenAnalystService;