...
/**
 * @class Ekmap.UGCSubLayer
 * @category  iServer Map Layer
 * @classdesc 地图服务图层属性信息类。影像图层（Image）、专题图层（ServerTheme）、栅格图层（Grid）、矢量图层（Vector）等图层均继承该类。
 * @extends {Ekmap.UGCMapLayer}
 * @param {Object} options - 参数。 
 * @param {Ekmap.DatasetInfo} options.datasetInfo - 数据集信息。 
 * @param {string} [options.displayFilter] - 图层显示过滤条件。 
 * @param {Ekmap.JoinItem} [options.joinItems] - 连接信息类。 
 * @param {string} [options.representationField] - 存储制图表达信息的字段。 
 * @param {Ekmap.LayerType} [options.ugcLayerType] - 图层类型。
 */
export class UGCSubLayer extends UGCMapLayer {
    ...
    constructor(options) {
        ...
        super(options);
        /**
         * @member {Ekmap.DatasetInfo} Ekmap.UGCSubLayer.prototype.datasetInfo
         * @description 数据集信息。
         */
        this.datasetInfo = null;

        /**
         * @member {string} Ekmap.UGCSubLayer.prototype.displayFilter
         * @description 图层显示过滤条件。
         */
        this.displayFilter = null;

        /**
         * @member {Ekmap.JoinItem} Ekmap.UGCSubLayer.prototype.joinItems
         * @description 连接信息类。
         */
        this.joinItems = null;

        /**
         * @member {string} Ekmap.UGCSubLayer.prototype.representationField
         * @description 存储制图表达信息的字段。
         */
        this.representationField = null;

        /**
         * @member {Ekmap.LayerType} Ekmap.UGCSubLayer.prototype.ugcLayerType
         * @description 图层类型。
         */
        this.ugcLayerType = null;

        this.CLASS_NAME = "Ekmap.UGCSubLayer";
    }


    /**
     * @function Ekmap.UGCSubLayer.prototype.fromJson
    ...
    /**
     * @function Ekmap.UGCSubLayer.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.UGCSubLayer.prototype.toServerJSONObject
