...
/**
 * @class Ekmap.UGCMapLayer
 * @category  iServer Map Layer
 * @classdesc UGC 地图图层类。
 * @extends {Ekmap.UGCLayer}
 ...
 * @param {Ekmap.OverlapDisplayedOptions} [options.overlapDisplayedOptions] - 地图的压盖过滤显示选项，当overlapDisplayed 为 false 时有效。
 */
export class UGCMapLayer extends UGCLayer {
    ...
    constructor(options) {
        ...
        super(options);
        /**
         * @member {boolean} Ekmap.UGCMapLayer.prototype.completeLineSymbolDisplayed
         * @description 是否显示完整线型。
         */
        this.completeLineSymbolDisplayed = null;

        /**
         * @member {number} Ekmap.UGCMapLayer.prototype.maxScale
         * @description 地图最大比例尺。
         */
        this.maxScale = null;

        /**
         * @member {number} Ekmap.UGCMapLayer.prototype.minScale
         * @description 地图最小比例尺。
         */
        this.minScale = null;

        /**
         * @member {number} Ekmap.UGCMapLayer.prototype.minVisibleGeometrySize
         * @description 几何对象的最小可见大小，以像素为单位。
         */
        this.minVisibleGeometrySize = null;

        /**
         * @member {number} Ekmap.UGCMapLayer.prototype.opaqueRate
         * @description 图层的不透明度。
         */
        this.opaqueRate = null;
        /**
         * @member {boolean} Ekmap.UGCMapLayer.prototype.symbolScalable
         * @description 是否允许图层的符号大小随图缩放。
         */
        this.symbolScalable = null;

        /**
         * @member {number} Ekmap.UGCMapLayer.prototype.symbolScale
         * @description 图层的符号缩放基准比例尺。
         */
        this.symbolScale = null;

        /**
         * @member {boolean} [Ekmap.UGCMapLayer.prototype.overlapDisplayed=false]
         * @description 地图对象在同一范围内时，是否重叠显示。
         */
        this.overlapDisplayed = null;

        /**
         * @member {Ekmap.OverlapDisplayedOptions} Ekmap.UGCMapLayer.prototype.overlapDisplayedOptions
         * @description 地图的压盖过滤显示选项，当 overlapDisplayed 为 false 时有效。
         */
        this.overlapDisplayedOptions = null;

        this.CLASS_NAME = "Ekmap.UGCMapLayer";
    }

    /**
     * @function Ekmap.UGCMapLayer.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.UGCMapLayer.prototype.fromJson
    ...
    /**
     * @function Ekmap.UGCMapLayer.prototype.toServerJSONObject
