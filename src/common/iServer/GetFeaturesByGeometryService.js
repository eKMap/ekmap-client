...
/**
 * @class Ekmap.GetFeaturesByGeometryService
 ...
 * @example
 * var myService = new Ekmap.GetFeaturesByGeometryService(url, {
 *     eventListeners: {
...
export class GetFeaturesByGeometryService extends GetFeaturesServiceBase {
    ...
    constructor(url, options) {
        super(url, options);
        this.CLASS_NAME = "Ekmap.GetFeaturesByGeometryService";
    }

    /**
     * @function Ekmap.GetFeaturesByGeometryService.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.GetFeaturesByGeometryService.prototype.getJsonParameters
     * @param {Ekmap.GetFeaturesByGeometryParameters} params - 数据集几何查询参数类。
...
Ekmap.GetFeaturesByGeometryService = GetFeaturesByGeometryService;