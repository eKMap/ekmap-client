...
/**
 * @class Ekmap.SurfaceAnalystParameters
 ...
 * {@link Ekmap.DatasetSurfaceAnalystParameters} 和 {@link Ekmap.GeometrySurfaceAnalystParameters} 继承自该类。
...
export class SurfaceAnalystParameters {
    ...
    constructor(options) {
        /**
         * @member {number} Ekmap.SurfaceAnalystParameters.prototype.resolution
         * @description 获取或设置指定中间结果（栅格数据集）的分辨率。
         */
        this.resolution = 0;

        /**
         * @member {Ekmap.SurfaceAnalystParametersSetting} Ekmap.SurfaceAnalystParameters.prototype.extractParameter
        ...
        /**
         * @member {Ekmap.DataReturnOption} Ekmap.SurfaceAnalystParameters.prototype.resultSetting
         * @description 结果返回设置类。
         */
        this.resultSetting = new DataReturnOption();

        /**
         * @member {Ekmap.SurfaceAnalystMethod} [Ekmap.SurfaceAnalystParameters.prototype.surfaceAnalystMethod=Ekmap.SurfaceAnalystMethod.ISOLINE]
        ...
        this.CLASS_NAME = "Ekmap.SurfaceAnalystParameters";
    }

    /**
     * @function Ekmap.SurfaceAnalystParameters.prototype.destroy
...
Ekmap.SurfaceAnalystParameters = SurfaceAnalystParameters;