 ...
 * @param {Array.<Ekmap.ThemeGridUniqueItem>} options.items - 栅格单值专题图子项数组。
 * @param {Ekmap.ServerColor} [options.defaultcolor] - 栅格单值专题图的默认颜色。
 */
export class ThemeGridUnique extends Theme {
    ...
    constructor(options) {
        ...
        /**
         * @member {Ekmap.ServerColor} Ekmap.ThemeGridUnique.prototype.defaultcolor
        ...
        /**
         * @member {Array.<Ekmap.ThemeGridUniqueItem>} Ekmap.ThemeGridUnique.prototype.items
        ...
        this.CLASS_NAME = "Ekmap.ThemeGridUnique";
    }

    /**
     * @function Ekmap.ThemeGridUnique.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.ThemeGridUnique.prototype.toServerJSONObject
    ...
    /**
     * @function Ekmap.ThemeGridUnique.fromObj
     * @description 从传入对象获取栅格单值专题图类。
     * @param {Object} obj - 传入对象
     * @returns {Ekmap.ThemeGridUnique} ThemeGridUnique 对象
     */
    static fromObj(obj) {
...
Ekmap.ThemeGridUnique = ThemeGridUnique;