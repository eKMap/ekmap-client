 ...
 * @param {Ekmap.ServerStyle} [options.leaderLineStyle] - 标签或符号与其标注对象之间牵引线的风格。
 */
export class ThemeFlow {

    constructor(options) {
        /**
         * @member {boolean} [Ekmap.ThemeFlow.prototype.flowEnabled=false]
        ...
        /**
         * @member {boolean} [Ekmap.ThemeFlow.prototype.leaderLineDisplayed=false]
        ...
        /**
         * @member {Ekmap.ServerStyle} Ekmap.ThemeFlow.prototype.leaderLineStyle
        ...
        this.CLASS_NAME = "Ekmap.ThemeFlow";
    }

    /**
     * @function Ekmap.ThemeFlow.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeFlow.fromObj
     * @description 从传入对象获取标签或符号流动显示和牵引线风格设置类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeFlow} ThemeFlow 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
