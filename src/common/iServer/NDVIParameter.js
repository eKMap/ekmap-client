...
export class NDVIParameter extends RasterFunctionParameter {
    constructor(options) {
        super(options);
        /**
         * @member {number} [Ekmap.NDVIParameter.prototype.redIndex=0]
         * @description 红光谱波段索引。
         */
        this.redIndex = 0;

        /**
         * @member {number} [Ekmap.NDVIParameter.prototype.nirIndex=1]
         * @description 近红外光谱波段索引。
         */
        this.nirIndex = 1;

        /**
         * @member {string} [Ekmap.NDVIParameter.prototype.colorMap="0:ffffe5ff;0.1:f7fcb9ff;0.2:d9f0a3ff;0.3:addd8eff;0.4:78c679ff;0.5:41ab5dff;0.6:238443ff;0.7:006837ff;1:004529ff"]
        ...
        this.CLASS_NAME = 'Ekmap.NDVIParameter';
    }

    /**
     * @function Ekmap.NDVIParameter.prototype.destroy
     * @override
     */
    destroy() {
            super.destroy();
        ...
        /**
         * @function Ekmap.NDVIParameter.prototype.toJSON
...
Ekmap.NDVIParameter = NDVIParameter;