...
/**
 * @class Ekmap.ChartFeatureInfoSpecsService
...
export class ChartFeatureInfoSpecsService extends CommonServiceBase {
    ...
    constructor(url, options) {
        super(url, options);
        this.CLASS_NAME = "Ekmap.ChartFeatureInfoSpecsService";
    }

    /**
     * @function Ekmap.ChartFeatureInfoSpecsService.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.ChartFeatureInfoSpecsService.prototype.processAsync
...
Ekmap.ChartFeatureInfoSpecsService = ChartFeatureInfoSpecsService;