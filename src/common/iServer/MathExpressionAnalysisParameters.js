...
/**
 * @class Ekmap.MathExpressionAnalysisParameters
 ...
 * @param {(Ekmap.Geometry.Polygon|L.Polygon|ol.geom.Polygon)} [options.extractRegion] - 栅格代数运算的范围，指定数据集中参与栅格代数运算的区域。
...
export class MathExpressionAnalysisParameters {
    ...
    constructor(options) {
        ...
        /**
         * @member {string} Ekmap.MathExpressionAnalysisParameters.prototype.dataset
        ...
        /**
         * @member {(Ekmap.Geometry.Polygon|L.Polygon|ol.geom.Polygon)} [Ekmap.MathExpressionAnalysisParameters.prototype.extractRegion]
        ...
        /**
         * @member {string} Ekmap.MathExpressionAnalysisParameters.prototype.expression
         * @description 指定的栅格运算表达式。如："[DatasourceAlias1.Raster1]*2-10"。
         */
        this.expression = null;

        /**
         * @member {boolean} [Ekmap.MathExpressionAnalysisParameters.prototype.isZip=false]
         * @description 是否对结果数据集进行压缩处理。
         */
        this.isZip = false;

        /**
         * @member {boolean} [Ekmap.MathExpressionAnalysisParameters.prototype.ignoreNoValue=false]
         * @description 是否忽略无值栅格数据。
         */
        this.ignoreNoValue = false;

        /**
         * @member {string} Ekmap.MathExpressionAnalysisParameters.prototype.targetDatasource
         * @description 指定存储结果数据集的数据源。
         */
        this.targetDatasource = null;

        /**
         * @member {string} Ekmap.MathExpressionAnalysisParameters.prototype.resultGridName
         * @description 指定结果数据集名称。
         */
        this.resultGridName = null;

        /**
         * @member {boolean} [Ekmap.MathExpressionAnalysisParameters.prototype.deleteExistResultDataset=false]
        ...
        this.CLASS_NAME = "Ekmap.MathExpressionAnalysisParameters"
    }


    /**
     * @function Ekmap.MathExpressionAnalysisParameters.prototype.destroy
    ...
    /**
     * @function Ekmap.MathExpressionAnalysisParameters.toObject
...
Ekmap.MathExpressionAnalysisParameters = MathExpressionAnalysisParameters;