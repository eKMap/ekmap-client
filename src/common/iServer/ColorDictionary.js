 ...
 * @param {Ekmap.ServerColor} options.color - 服务端颜色类。
 */
export class ColorDictionary {
    ...
    constructor(options) {
        ...
        /**
         * @member {number} Ekmap.ColorDictionary.prototype.elevation
         * @description 高程值。
         */
        this.elevation = null;

        /**
         * @member {Ekmap.ServerColor} Ekmap.ColorDictionary.prototype.color
         * @description 服务端颜色类。
         */
        this.color = null;
        ...
        this.CLASS_NAME = "Ekmap.ColorDictionary";
    }

    /**
     * @function Ekmap.ColorDictionary.prototype.destroy
    ...
    /**
     * @function Ekmap.ColorDictionary.prototype.toServerJSONObject
...
Ekmap.ColorDictionary = ColorDictionary;