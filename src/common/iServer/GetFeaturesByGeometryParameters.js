...
/**
 * @class Ekmap.GetFeaturesByGeometryParameters
...
export class GetFeaturesByGeometryParameters extends GetFeaturesParametersBase {
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Ekmap.GetFeaturesByGeometryParameters.prototype.getFeatureMode
        ...
        /**
         * @member {Object} Ekmap.GetFeaturesByGeometryParameters.prototype.geometry
        ...
        /**
         * @member {Array.<string>} Ekmap.GetFeaturesByGeometryParameters.prototype.fields
         * @description 设置查询结果返回字段。当指定了返回结果字段后，则 GetFeaturesResult 中的 features 的属性字段只包含所指定的字段。不设置即返回全部字段。
         */
        this.fields = null;

        /**
         * @member {string} Ekmap.GetFeaturesByGeometryParameters.prototype.attributeFilter
         *  @description 几何查询属性过滤条件。
         */
        this.attributeFilter = null;

        /**
         * @member {Ekmap.SpatialQueryMode} [Ekmap.GetFeaturesByGeometryParameters.prototype.spatialQueryMode=Ekmap.SpatialQueryMode.CONTAIN]
         * @description 空间查询模式常量。
         */
        this.spatialQueryMode = SpatialQueryMode.CONTAIN;
        Util.extend(this, options);

        this.CLASS_NAME = "Ekmap.GetFeaturesByGeometryParameters";
    }


    /**
     * @function Ekmap.GetFeaturesByGeometryParameters.prototype.destroy
    ...
    /**
     * @function Ekmap.GetFeaturesByGeometryParameters.toJsonParameters
     * @description 将 Ekmap.GetFeaturesByGeometryParameters 对象参数转换为 JSON 字符串。
     * @param {Ekmap.GetFeaturesByGeometryParameters} params - 查询参数对象。
...
Ekmap.GetFeaturesByGeometryParameters = GetFeaturesByGeometryParameters;