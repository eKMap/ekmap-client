...
/**
 * @class Ekmap.InterpolationIDWAnalystParameters
 ...
 * @param {string} [options.dataset] - 要用来做插值分析的数据源中数据集的名称。该名称用形如”数据集名称@数据源别名”形式来表示。当插值分析类型(Ekmap.InterpolationAnalystType)为 dataset 时，必设参数。 
 ...
 * @example 例如：
 * var myInterpolationIDWAnalystParameters = new Ekmap.InterpolationIDWAnalystParameters({
...
export class InterpolationIDWAnalystParameters extends InterpolationAnalystParameters {
    ...
    constructor(options) {
        super(options);
        /**
         * @member {number} [Ekmap.InterpolationIDWAnalystParameters.prototype.power=2]
        ...
        /**
         * @member {Ekmap.SearchMode} Ekmap.InterpolationIDWAnalystParameters.prototype.searchMode
        ...
        /**
         * @member {number} [Ekmap.InterpolationIDWAnalystParameters.prototype.expectedCount=12]
        ...
        this.CLASS_NAME = "Ekmap.InterpolationIDWAnalystParameters";
    }

    /**
     * @function Ekmap.InterpolationIDWAnalystParameters.prototype.destroy
...
Ekmap.InterpolationIDWAnalystParameters = InterpolationIDWAnalystParameters;