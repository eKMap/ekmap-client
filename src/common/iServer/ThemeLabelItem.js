 ...
 *              他们所代表的分段区间分别为[0,5)，[5,10)。那么需要分别设置 Ekmap.ThemeLabelItem[0].start=0，
 *              Ekmap.ThemeLabelItem[0].end=5，SuperMap.ThemeLabelItem[1].start=5，SuperMap.ThemeLabelItem[1].end=10。
 ...
 * @param {Ekmap.ServerTextStyle} [options.style] - 标签专题图子项文本的显示风格。
 */
export class ThemeLabelItem {

    constructor(options) {
        /**
         * @member {string} [Ekmap.ThemeLabelItem.prototype.caption]
         * @description 标签专题子项的标题。
         */
        this.caption = null;

        /**
         * @member {number} [Ekmap.ThemeLabelItem.prototype.end=0]
        ...
        /**
         * @member {number} [Ekmap.ThemeLabelItem.prototype.start=0]
        ...
        /**
         * @member {boolean} [Ekmap.ThemeLabelItem.prototype.visible=true]
         * @description 标签专题图子项是否可见。如果标签专题图子项可见，则为 true，否则为 false。
         */
        this.visible = true;

        /**
         * @member {Ekmap.ServerTextStyle} Ekmap.ThemeLabelItem.prototype.style
        ...
        this.CLASS_NAME = "Ekmap.ThemeLabelItem";

    }


    /**
     * @function Ekmap.ThemeLabelItem.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeLabelItem.fromObj
     * @description 从传入对象获取分段标签专题图的子项类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeLabelItem} ThemeLabelItem 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
...
Ekmap.ThemeLabelItem = ThemeLabelItem;