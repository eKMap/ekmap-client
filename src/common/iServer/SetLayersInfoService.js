...
/**
 * @class Ekmap.SetLayersInfoService
...
export class SetLayersInfoService extends CommonServiceBase {
    ...
    constructor(url, options) {
        super(url, options);
        /**
         * @member {string} Ekmap.SetLayersInfoService.prototype.resourceID
         * @description 图层资源ID，临时图层的资源ID标记。
         */
        this.resourceID = null;

        /**
         * @function {boolean} Ekmap.SetLayersInfoService.prototype.isTempLayers
        ...
        this.CLASS_NAME = "Ekmap.SetLayersInfoService";
    }
    ...
    /**
     * @function Ekmap.SetLayersInfoService.prototype.processAsync
     * @description 负责将客户端的更新参数传递到服务端。
     * @param {Object} params - 修改后的图层资源信息。该参数可以使用获取图层信息服务 <{@link Ekmap.GetLayersInfoService}>返回图层信息，然后对其属性进行修改来获取。
     */
    processAsync(params) {
        if (!params) {
            return;
...
Ekmap.SetLayersInfoService = SetLayersInfoService;