...
/**
 * @class Ekmap.ThemeGraph
 * @category  iServer Map Theme
 * @classdesc 统计专题图类。
 * @extends {Ekmap.Theme}
 * @param {Object} options - 参数。
 * @param {Array.<Ekmap.ThemeGraphItem>} options.items - 统计专题图子项集合。
 * @param {number}  [options.barWidth=0] - 柱状专题图中每一个柱的宽度。
 * @param {Ekmap.ThemeFlow} [options.flow] - 统计专题图流动显示与牵引线设置。
 * @param {Ekmap.GraduatedMode} [options.graduatedMode=Ekmap.GraduatedMode.CONSTANT] - 统计图中地理要素的值与图表尺寸间的映射关系。
 * @param {Ekmap.ThemeGraphAxes} [options.graphAxes] - 统计图中坐标轴样式相关信息。
 * @param {Ekmap.ThemeGraphSize} [options.graphSize=0] - 统计符号的最大最小尺寸。
 * @param {boolean} [options.graphSizeFixed=false] - 缩放地图时统计图符号是否固定大小。
 * @param {Ekmap.ThemeGraphText} [options.graphText] - 统计图上的文字是否可以见以及文字标注风格。
 * @param {Ekmap.GraphAxesTextDisplayMode} [options.graphAxesTextDisplayMode=Ekmap.GraphAxesTextDisplayMode.NONE] - 统计专题图坐标轴文本显示模式。
 * @param {Ekmap.ThemeGraphType} [options.graphType=Ekmap.ThemeGraphType.AREA] - 统计专题图类型。
 * @param {Array.<number>} [options.memoryKeys] - 以内存数组方式制作专题图时的键数组。
 * @param {boolean} [options.negativeDisplayed=false] - 专题图中是否显示属性为负值的数据。
 * @param {Ekmap.ThemeOffset} [options.offset] - 统计图相对于要素内点的偏移量。
...
export class ThemeGraph extends Theme {
    ...
    constructor(options) {
        super("GRAPH", options);
        /**
         * @member {number} [Ekmap.ThemeGraph.prototype.barWidth=0]
        ...
        /**
         * @member {Ekmap.ThemeFlow} Ekmap.ThemeGraph.prototype.flow
        ...
        /**
         * @member {Ekmap.GraduatedMode} [Ekmap.ThemeGraph.prototype.graduatedMode=Ekmap.GraduatedMode.CONSTANT]
        ...
        /**
         * @member {Ekmap.ThemeGraphAxes} Ekmap.ThemeGraph.prototype.graphAxes
         * @description 用于设置统计图中坐标轴样式相关信息，如坐标轴颜色、是否显示、坐标文本样式等。
         */
        this.graphAxes = new ThemeGraphAxes();

        /**
         * @member {Ekmap.ThemeGraphSize} [Ekmap.ThemeGraph.prototype.graphSize=0]
         * @description 用于设置统计符号的最大最小尺寸。
         */
        this.graphSize = new ThemeGraphSize();

        /**
         * @member {boolean} [Ekmap.ThemeGraph.prototype.graphSizeFixed=false]
         * @description 缩放地图时统计图符号是否固定大小。即统计图符号将随地图缩放。
         */
        this.graphSizeFixed = false;

        /**
         * @member {Ekmap.ThemeGraphText} Ekmap.ThemeGraph.prototype.graphText
         * @description 统计图上的文字是否可以见以及文字标注风格。
         */
        this.graphText = new ThemeGraphText();

        /**
         * @member {Ekmap.ThemeGraphType} [Ekmap.ThemeGraph.prototype.graphType=Ekmap.ThemeGraphType.AREA]
        ...
        /**
         * @member {Ekmap.GraphAxesTextDisplayMode} [Ekmap.ThemeGraph.prototype.graphAxesTextDisplayMode=Ekmap.GraphAxesTextDisplayMode.NONE]
         * @description 统计专题图坐标轴文本显示模式。
         */
        this.graphAxesTextDisplayMode = GraphAxesTextDisplayMode.NONE;

        /**
         * @member {Array.<Ekmap.ThemeGraphItem>} Ekmap.ThemeGraph.prototype.items
        ...
        /**
         * @member {Array.<number>} Ekmap.ThemeGraph.prototype.memoryKeys
         * @description 以内存数组方式制作专题图时的键数组。
         *              键数组内的数值代表 SmID 值，它与 Ekmap.ThemeGraphItem 类中的值数组（SuperMap.ThemeGraphItem.memoryDoubleValues）要关联起来应用。
         ...
         *      var style1 = new Ekmap.ServerStyle({
         *                   fillForeColor: new Ekmap.ServerColor(92,73,234),
         *                   lineWidth: 0.1
         *               }),
         *               style2 = new Ekmap.ServerStyle({
         *                   fillForeColor: new Ekmap.ServerColor(211,111,240),
         *                   lineWidth: 0.1
         *               }),
         *               item1 = new Ekmap.ThemeGraphItem({
         *                   memoryDoubleValues:[1.18,0.95,0.37,1.31,0.8,1.5],
         *                  caption: "1992-1995人口增长率",
         *                  graphExpression: "Pop_Rate95",
         *                   uniformStyle: style1
         *               }),
         *               item2 = new Ekmap.ThemeGraphItem({
         *               //以内存数组方式制作专题图时的值数组
         ...
         *               }),
         *               themeGraph  = new Ekmap.ThemeGraph({
         *               //以内存数组方式制作专题图时的键数组，键数组内的数值代表 SmID 值
         *                    memoryKeys:[1,2,4,8,10,12],
         *                   items: new Array(item1,item2),
         *                   barWidth: 0.03,
         *                    //统计图中地理要素的值与图表尺寸间的映射关系为平方根
         *                   graduatedMode: Ekmap.GraduatedMode.SQUAREROOT,
         *                   //graphAxes用于设置统计图中坐标轴样式相关信息
         *                   graphAxes: new Ekmap.ThemeGraphAxes({
         *                       axesDisplayed: true
         *                   }),
         *                   graphSize: new Ekmap.ThemeGraphSize({
         *                       maxGraphSize: 1,
         *                       minGraphSize: 0.35
         *                   }),
         *                   //统计图上的文字是否可以见以及文字标注风格
         *                   graphText: new Ekmap.ThemeGraphText({
         *                       graphTextDisplayed: true,
         *                       graphTextFormat: Ekmap.ThemeGraphTextFormat.VALUE,
         *                       graphTextStyle: new Ekmap.ServerTextStyle({
         *                           sizeFixed: true,
         *                           fontHeight: 9,
         *                           fontWidth: 5
         *                       })
         *                   }),
         *                   //统计专题图类型为三维柱状图
         *                   graphType: Ekmap.ThemeGraphType.BAR3D
         *               }),
         *                   //专题图参数对象
         *               themeParameters = new Ekmap.ThemeParameters({
         *                   themes: [themeGraph],
         *                   dataSourceNames: ["Jingjin"],
         *                   datasetNames: ["BaseMap_R"]
         *               }),
         *                   //与服务端交互
         *               themeService=new Ekmap.ThemeService(url, {
         *                   eventListeners: {
        ...
        /**
         * @member {boolean} [Ekmap.ThemeGraph.prototype.negativeDisplayed=false]
         * @description 专题图中是否显示属性为负值的数据。true 表示显示；falese 不显示。
         */
        this.negativeDisplayed = false;

        /**
         * @member {Ekmap.ThemeOffset} Ekmap.ThemeGraph.prototype.offset
         * @description 用于设置统计图相对于要素内点的偏移量。
         */
        this.offset = new ThemeOffset();

        /**
         * @member {boolean} Ekmap.ThemeGraph.prototype.overlapAvoided
        ...
        /**
         * @member {number} [Ekmap.ThemeGraph.prototype.roseAngle=0]
         * @description 统计图中玫瑰图或三维玫瑰图用于等分的角度，默认为 0 度，精确到 0.1 度。在角度为0或者大于 360 度的情况下均使用 360 度来等分制作统计图的字段数。
         */
        this.roseAngle = 0;

        /**
         * @member {number} [Ekmap.ThemeGraph.prototype.startAngle=0]
        ...
        this.CLASS_NAME = "Ekmap.ThemeGraph";
    }


    /**
     * @function Ekmap.ThemeGraph.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.ThemeGraph.prototype.toJSON
     * @description 将 Ekmap.ThemeGraph 对象转化为 JSON 字符串。
    ...
    /**
     * @function Ekmap.ThemeGraph.prototype.toServerJSONObject
    ...
    /**
     * @function Ekmap.ThemeGraph.fromObj
     * @description 从传入对象获取统计专题图类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeGraph} ThemeGraph 对象。
     */
    static fromObj(obj) {
