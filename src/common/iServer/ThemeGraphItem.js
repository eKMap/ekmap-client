 ...
 * @param {Ekmap.ServerStyle} [options.uniformStyle] - 统计专题图子项的显示风格
 */
export class ThemeGraphItem {
    ...
    constructor(options) {
        ...
        /**
         * @member {string} [Ekmap.ThemeGraphItem.prototype.caption]
         * @description 专题图子项的名称。
         */
        this.caption = null;

        /**
         * @member {string} Ekmap.ThemeGraphItem.prototype.graphExpression
         * @description 统计专题图的专题变量。专题变量可以是一个字段或字段表达式。字段必须为数值型；表达式只能为数值型的字段间的运算。
         */
        this.graphExpression = null;

        /**
         * @member {Array.<number>} [Ekmap.ThemeGraphItem.prototype.memoryDoubleValues]
         * @description 内存数组方式制作专题图时的值数组。<br>
         *              内存数组方式制作专题图时，只对 SmID 值在键数组（{@link Ekmap.ThemeGraph.memoryKeys}）中的记录制作专题图。
        ...
        /**
         * @member {Ekmap.ServerStyle} [Ekmap.ThemeGraphItem.prototype.uniformStyle]
        ...
        this.CLASS_NAME = "Ekmap.ThemeGraphItem";
    }

    /**
     * @function Ekmap.ThemeGraphItem.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeGraphItem.fromObj
     * @description 从传入对象获取统计专题图子项类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeGraphItem} ThemeGraphItem 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
...
Ekmap.ThemeGraphItem = ThemeGraphItem;