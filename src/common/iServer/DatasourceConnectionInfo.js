...
/**
 * @class Ekmap.DatasourceConnectionInfo
 ...
 * @param {Ekmap.EngineType} [options.engineType] - 数据源连接的引擎类型。 
 * @param {boolean} [options.exclusive] - 是否以独占方式打开数据源。 
 * @param {boolean} [options.OpenLinkTable] - 是否把数据库中的其他非 Ekmap 数据表作为 LinkTable 打开。 
...
export class DatasourceConnectionInfo {
    ...
    constructor(options) {
        ...
        /**
         * @member {string} Ekmap.DatasourceConnectionInfo.prototype.alias
         * @description 数据源别名。
         */
        this.alias = null;

        /**
         * @member {boolean} [Ekmap.DatasourceConnectionInfo.prototype.connect]
         * @description 数据源是否自动连接数据。
         */
        this.connect = null;

        /**
         * @member {string} Ekmap.DatasourceConnectionInfo.prototype.dataBase
         * @description 数据源连接的数据库名。
         */
        this.dataBase = null;

        /**
         * @member {string} [Ekmap.DatasourceConnectionInfo.prototype.driver]
        ...
        /**
         * @member {Ekmap.EngineType} [Ekmap.DatasourceConnectionInfo.prototype.engineType]
         * @description 数据源连接的引擎类型。
         */
        this.engineType = null;

        /**
         * @member {boolean} [Ekmap.DatasourceConnectionInfo.prototype.exclusive]
         * @description 是否以独占方式打开数据源。
         */
        this.exclusive = null;

        /**
         * @member {boolean} [Ekmap.DatasourceConnectionInfo.prototype.OpenLinkTable]
         * @description 是否把数据库中的其他非 Ekmap 数据表作为 LinkTable 打开。
         */
        this.OpenLinkTable = null;

        /**
         * @member {string} [Ekmap.DatasourceConnectionInfo.prototype.password]
         * @description 登录数据源连接的数据库或文件的密码。
         */
        this.password = null;

        /**
         * @member {boolean} [Ekmap.DatasourceConnectionInfo.prototype.readOnly]
         * @description 是否以只读方式打开数据源。
         */
        this.readOnly = null;

        /**
         * @member {string} [Ekmap.DatasourceConnectionInfo.prototype.server]
        ...
        /**
         * @member {string} Ekmap.DatasourceConnectionInfo.prototype.user
        ...
        this.CLASS_NAME = "Ekmap.DatasourceConnectionInfo";
    }

    /**
     * @function Ekmap.DatasourceConnectionInfo.prototype.destroy
...
Ekmap.DatasourceConnectionInfo = DatasourceConnectionInfo;