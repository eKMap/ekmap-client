...
/**
 * @class Ekmap.SurfaceAnalystParametersSetting
 * @category  iServer SpatialAnalyst SurfaceAnalyst
 * @classdesc 表面分析参数设置类。
 * 通过该类可以设置表面分析提取等值线、提取等值面的一些参数，包括基准值、等值距、光滑度、光滑方法等。
 * @param {Object} options - 参数。
 * @param {(Ekmap.Geometry.Polygon|L.Polygon|ol.geom.Polygon)} [options.clipRegion] - 获取或设置裁剪面对象，如果不需要对操作结果进行裁剪，可以使用 null 值取代该参数。
 ...
 * @param {Ekmap.SmoothMethod} [options.smoothMethod=Ekmap.SmoothMethod.BSPLINE] - 获取或设置光滑处理所使用的方法。
...
export class SurfaceAnalystParametersSetting {
    ...
    constructor(options) {
        /**
         * @member {(Ekmap.Geometry.Polygon|L.Polygon|ol.geom.Polygon)} [Ekmap.SurfaceAnalystParametersSetting.prototype.clipRegion]
         * @description 获取或设置裁剪面对象，如果不需要对操作结果进行裁剪，可以使用 null 值取代该参数。
         */
        this.clipRegion = null;

        /**
         * @member {number} [Ekmap.SurfaceAnalystParametersSetting.prototype.datumValue=0]
        ...
        this.datumValue = 0;
        /**
         * @member {Array.<number>} Ekmap.SurfaceAnalystParametersSetting.prototype.expectedZValues
        ...
        /**
         *  @member {number} [Ekmap.SurfaceAnalystParametersSetting.prototype.interval=0]
         *  @description 获取或设置等值距。等值距是两条等值线之间的间隔值。
         */
        this.interval = 0;

        /**
         * @member {number} [Ekmap.SurfaceAnalystParametersSetting.prototype.resampleTolerance=0]
        ...
        /**
         * @member {Ekmap.SmoothMethod} [Ekmap.SurfaceAnalystParametersSetting.prototype.smoothMethod=Ekmap.SmoothMethod.BSPLINE]
         * @description 获取或设置光滑处理所使用的方法。
         */
        this.smoothMethod = SmoothMethod.BSPLINE;

        /**
         * @member {number} [Ekmap.SurfaceAnalystParametersSetting.prototype.smoothness=0]
        ...
        this.CLASS_NAME = "Ekmap.SurfaceAnalystParametersSetting";
    }


    /**
     * @function Ekmap.SurfaceAnalystParametersSetting.prototype.destroy
    ...
    destroy() {
        ...
        /**
         * @function Ekmap.SurfaceAnalystParametersSetting.prototype.toJSON
...
Ekmap.SurfaceAnalystParametersSetting = SurfaceAnalystParametersSetting;