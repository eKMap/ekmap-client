...
/**
 * @class Ekmap.QueryByDistanceParameters
...
export class QueryByDistanceParameters extends QueryParameters {
    ...
    constructor(options) {
        ...
        super(options);
        /**
         * @member {number} [Ekmap.QueryByDistanceParameters.prototype.distance=0]
        ...
        /**
         * @member Ekmap.QueryByDistanceParameters.prototype.geometry
        ...
        /**
         * @member {boolean} [Ekmap.QueryByDistanceParameters.prototype.isNearest=false]
         * @description 是否为最近距离查询。<br>
         *               建议该属性与 expectCount（继承自 {@link Ekmap.QueryParameters}）属性联合使用。
        ...
        /**
         * @member {boolean} [Ekmap.QueryByDistanceParameters.prototype.returnContent=true]
        ...
        this.CLASS_NAME = "Ekmap.QueryByDistanceParameters";
    }

    /**
     * @function Ekmap.QueryByDistanceParameters.prototype.destroy
...
Ekmap.QueryByDistanceParameters = QueryByDistanceParameters;