...
/**
 * @class Ekmap.TransportationAnalystResultSetting
...
export class TransportationAnalystResultSetting {
    ...
    constructor(options) {
        ...
        /**
         * @member {boolean} Ekmap.TransportationAnalystResultSetting.prototype.returnEdgeFeatures
         * @description 是否在分析结果中包含弧段要素集合。弧段要素包括弧段的空间信息和属性信息。
         */
        this.returnEdgeFeatures = false;

        /**
         * @member {boolean} [Ekmap.TransportationAnalystResultSetting.prototype.returnEdgeGeometry=false]
         * @description 返回的弧段要素集合中是否包含几何对象信息。
         */
        this.returnEdgeGeometry = false;

        /**
         * @member {boolean} [Ekmap.TransportationAnalystResultSetting.prototype.returnEdgeIDs=false]
         * @description 返回结果中是否包含经过弧段 ID 集合。
         */
        this.returnEdgeIDs = false;

        /**
         * @member {boolean} [Ekmap.TransportationAnalystResultSetting.prototype.returnNodeFeatures=false]
        ...
        /**
         * @member {boolean} [Ekmap.TransportationAnalystResultSetting.prototype.returnNodeGeometry=false]
         * @description 返回的结点要素集合中是否包含几何对象信息。
         */
        this.returnNodeGeometry = false;

        /**
         * @member {boolean} [Ekmap.TransportationAnalystResultSetting.prototype.returnNodeIDs=false]
         * @description 返回结果中是否包含经过结点 ID 集合。
         */
        this.returnNodeIDs = false;

        /**
         * @member {boolean} Ekmap.TransportationAnalystResultSetting.prototype.returnPathGuides
         * @description 返回分析结果中是否包含行驶导引集合。
         */
        this.returnPathGuides = false;

        /**
         * @member {boolean} Ekmap.TransportationAnalystResultSetting.prototype.returnRoutes
        ...
        this.CLASS_NAME = "Ekmap.TransportationAnalystResultSetting";
    }

    /**
     * @function Ekmap.TransportationAnalystResultSetting.prototype.destroy
...
Ekmap.TransportationAnalystResultSetting = TransportationAnalystResultSetting;