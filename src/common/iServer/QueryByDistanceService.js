...
/**
 * @class Ekmap.QueryByDistanceService
 * @category  iServer Map QueryResults
 * @classdesc Distance查询服务类。
 * @extends {Ekmap.QueryService}
 * @example
 * var myQueryByDistService = new Ekmap.QueryByDistanceService(url, {
 *     eventListeners: {
...
export class QueryByDistanceService extends QueryService {
    ...
    constructor(url, options) {
        super(url, options);
        this.CLASS_NAME = "Ekmap.QueryByDistanceService";
    }
    ...
    /**
     * @function Ekmap.QueryByDistanceService.prototype.getJsonParameters
     * @description 将查询参数转化为 JSON 字符串。
     *              在本类中重写此方法，可以实现不同种类的查询（sql, geometry, distance, bounds等）。
     * @param {Ekmap.QueryByDistanceParameters} params - Distance 查询参数类。
...
Ekmap.QueryByDistanceService = QueryByDistanceService;