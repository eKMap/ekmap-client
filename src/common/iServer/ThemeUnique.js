 ...
 * @param {Array.<Ekmap.ThemeUniqueItem>} options.items - 单值专题图子项类数组。
 * @param {string} options.uniqueExpression - 用于制作单值专题图的字段或字段表达式。
 * @param {Ekmap.ServerStyle} [options.defaultStyle] - 未参与单值专题图制作的对象的显示风格。
...
export class ThemeUnique extends Theme {
    ...
    constructor(options) {
        ...
        /**
         * @member {Ekmap.ServerStyle} Ekmap.ThemeUnique.prototype.defaultStyle
        ...
        /**
         * @member {Array.<Ekmap.ThemeUniqueItem>} Ekmap.ThemeUnique.prototype.items
        ...
        /**
         * @member {string} Ekmap.ThemeUnique.prototype.uniqueExpression
        ...
        /**
         * @member {Ekmap.ColorGradientType} [Ekmap.ThemeUnique.prototype.colorGradientType=Ekmap.ColorGradientType.YELLOW_RED]
         * @description 渐变颜色枚举类。
        ...
        this.CLASS_NAME = "Ekmap.ThemeUnique";
    }

    /**
     * @function Ekmap.ThemeUnique.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.ThemeUnique.prototype.toServerJSONObject
    ...
    /**
     * @function Ekmap.ThemeUnique.fromObj
     * @description 从传入对象获取单值专题图类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeUnique} ThemeUnique 对象。
     */
    static fromObj(obj) {
