...
/**
 * @class Ekmap.DatasetOverlayAnalystParameters
 ...
 * @param {Ekmap.FilterParameter} [options.operateDatasetFilter] - 设置操作数据集中空间对象过滤条件。 
 * @param {Array.<Ekmap.Geometry.Polygon|L.Polygon|ol.geom.Polygon>} [options.operateRegions] - 操作面对象集合，表示与这些面对象进行叠加分析。与 operateDataset 参数互斥，冲突时以 operateDataset 为准。 
 * @param {Array.<string>} [options.sourceDatasetFields] - 叠加分析中源数据集保留在结果数据集中的字段名列表。 
 * @param {Ekmap.FilterParameter} [options.sourceDatasetFilter] - 设置源数据集中空间对象过滤条件。 
...
export class DatasetOverlayAnalystParameters extends OverlayAnalystParameters {
    ...
    constructor(options) {
        super(options);
        /**
         * @member {string} Ekmap.DatasetOverlayAnalystParameters.prototype.operateDataset
         * @description 叠加分析中操作数据集的名称。
         */
        this.operateDataset = null;

        /**
         * @member {Array.<string>} [Ekmap.DatasetOverlayAnalystParameters.prototype.operateDatasetFields]
         * @description 叠加分析中操作数据集保留在结果数据集中的字段名列表。
         */
        this.operateDatasetFields = [];

        /**
         * @member {Ekmap.FilterParameter} Ekmap.DatasetOverlayAnalystParameters.prototype.operateDatasetFilter
         * @description 设置操作数据集中空间对象过滤条件。
         */
        this.operateDatasetFilter = new FilterParameter();

        /**
         * @member {Array.<Ekmap.Geometry.Polygon|L.Polygon|ol.geom.Polygon>} [Ekmap.DatasetOverlayAnalystParameters.prototype.operateRegions]
        ...
        /**
         * @member {string} Ekmap.DatasetOverlayAnalystParameters.prototype.sourceDataset
        ...
        /**
         * @member {Array.<string>} [Ekmap.DatasetOverlayAnalystParameters.prototype.sourceDatasetFields]
        ...
        /**
         * @member {Ekmap.FilterParameter} [Ekmap.DatasetOverlayAnalystParameters.prototype.filterQueryParameter]
         * @description 设置源数据集中空间对象过滤条件。
         */
        this.sourceDatasetFilter = new FilterParameter();

        /**
         * @member {number} [Ekmap.DatasetOverlayAnalystParameters.prototype.tolerance=0]
         * @description 容限。
         */
        this.tolerance = 0;

        /**
         * @member {Ekmap.DataReturnOption} [Ekmap.DatasetOverlayAnalystParameters.prototype.resultSetting]
         * @description 结果返回设置类。
         */
        ...
        this.CLASS_NAME = "Ekmap.DatasetOverlayAnalystParameters";
    }


    /**
     * @function Ekmap.DatasetOverlayAnalystParameters.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.DatasetOverlayAnalystParameters.toObject
     * @param {Ekmap.DatasetOverlayAnalystParameters} datasetOverlayAnalystParameters - 数据集叠加分析参数类。
     * @param {Ekmap.DatasetOverlayAnalystParameters} tempObj - 数据集叠加分析参数对象。
...
Ekmap.DatasetOverlayAnalystParameters = DatasetOverlayAnalystParameters;