...
export class ThemeMemoryData {
    ...
    constructor(srcData, targetData) {
        /**
         * @member {Array} Ekmap.ThemeMemoryData.prototype.srcData
         * @description 原始值数组，该属性值将被 targetData 属性所指定的值替换掉，然后制作专题图，但数据库中的值并不会改变。
         */
        this.srcData = srcData;

        /**
         * @member {Array} Ekmap.ThemeMemoryData.prototype.targetData
         * @description 外部值数组，即用于制作专题图的内存数据，设定该属性值后，会将 srcData 属性所指定的原始值替换掉制作专题图，但数据库中的值并不会改变。
         */
        this.targetData = targetData;

        this.CLASS_NAME = "Ekmap.ThemeMemoryData";
    }

    /**
     * @function Ekmap.ThemeMemoryData.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeMemoryData.prototype.toJSON
     * @description 将 Ekmap.ThemeMemoryData 对象转化为 JSON 字符串。
...
Ekmap.ThemeMemoryData = ThemeMemoryData;