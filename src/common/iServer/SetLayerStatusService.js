...
/**
 * @class Ekmap.SetLayerStatusService
...
export class SetLayerStatusService extends CommonServiceBase {
    ...
    constructor(url, options) {
        ...
        this.CLASS_NAME = "Ekmap.SetLayerStatusService";
    }
    ...
    /**
     * @function Ekmap.SetLayerStatusService.prototype.processAsync
     * @description 负责将客户端的更新参数传递到服务端。
     * @param {Object} params - 修改后的图层资源信息。该参数可以使用获取图层信息服务{@link Ekmap.SetLayerStatusParameters}
    ...
    /**
     * @function Ekmap.SetLayerStatusService.prototype.createTempLayerComplete
    ...
    /**
     * @function Ekmap.SetLayerStatusService.prototype.getMapName
     * @description 获取地图名称。
    ...
    /**
     * @function Ekmap.SetLayerStatusService.prototype.setLayerCompleted
     * @description 设置完成，执行此方法。
     * @param {Object} result - 服务器返回的结果对象，记录设置操作是否成功。
     */
...
Ekmap.SetLayerStatusService = SetLayerStatusService;