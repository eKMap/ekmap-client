...
/**
 * @class Ekmap.ThemeLabel
 * @category  iServer Map Theme
 * @classdesc 标签专题图类。
 * @extends Ekmap.Theme
 * @param {Object} options - 参数。
 * @param {Array.<Ekmap.ThemeUniqueItem>} options.items - 分段标签专题图的子项数组。
 * @param {string} options.labelExpression - 标注字段表达式。
 * @param {Array.<Ekmap.LabelMatrixCell>} options.matrixCells - 矩阵标签元素数组。
 * @param {Ekmap.ThemeLabelAlongLine} [options.alongLine] - 标签沿线标注方向样式类。
 * @param {Ekmap.ThemeLabelBackground} [options.background] - 标签专题图中标签的背景风格类。
 * @param {Ekmap.ThemeFlow} [options.flow] - 标签专题图标签流动显示与牵引线设置类。
 * @param {Ekmap.LabelOverLengthMode} [options.labelOverLengthMode=Ekmap.LabelOverLengthMode.NONE] - 标签专题图中超长标签的处理模式枚举类。
 ...
 * @param {Ekmap.ThemeLabelText} options.text - 标签中文本风格。
...
export class ThemeLabel extends Theme {
    ...
    constructor(options) {
        super("LABEL", options);
        /**
         * @member {Ekmap.ThemeLabelAlongLine} [Ekmap.ThemeLabel.prototype.alongLine]
        ...
        /**
         * @member {Ekmap.ThemeLabelBackground} [Ekmap.ThemeLabel.prototype.background] 
         * @description 标签专题图中标签的背景风格类。通过该字段可以设置标签的背景形状和风格。
         */
        this.background = new ThemeLabelBackground();

        /**
         * @member {Ekmap.ThemeFlow} [Ekmap.ThemeLabel.prototype.flow]
         * @description 标签专题图标签流动显示与牵引线设置类。通过该字段可以设置标签是否流动显示和牵引线风格。
         */
        this.flow = new ThemeFlow();

        /**
         * @member {Array.<Ekmap.ThemeUniqueItem>} [Ekmap.ThemeLabel.prototype.items]
        ...
        /**
         * @member {Array.<Ekmap.ThemeLabelUniqueItem>} Ekmap.ThemeLabel.prototype.uniqueItems
         * @description 单值标签专题图子项数组。单值标签专题图使用 uniqueExpression单值标签专题图子项集合。
         */
        this.uniqueItems = null;

        /**
         * @member {string} Ekmap.ThemeLabel.prototype.labelExpression
         * @description 标注字段表达式。系统将 labelExpression 对应的字段或字段表达式的值以标签的形式显示在图层中。
         */
        this.labelExpression = null;

        /**
         * @member {Ekmap.LabelOverLengthMode} [Ekmap.ThemeLabel.prototype.labelOverLengthMode=Ekmap.LabelOverLengthMode.NONE] - 标签专题图中超长标签的处理模式枚举类。
         * @description 对于标签的长度超过设置的标签最大长度 maxLabelLength 时称为超长标签。
         */
        this.labelOverLengthMode = LabelOverLengthMode.NONE;

        /**
         * @member {Array.<Ekmap.LabelMatrixCell>} Ekmap.ThemeLabel.prototype.matrixCells
        ...
        /**
         * @member {number} [Ekmap.ThemeLabel.prototype.maxLabelLength=256]
        ...
        /**
         * @member {number} [Ekmap.ThemeLabel.prototype.numericPrecision=0]
        ...
        /**
         * @member {Ekmap.ThemeOffset} [Ekmap.ThemeLabel.prototype.offset]
         * @description 用于设置标签专题图中标记文本相对于要素内点的偏移量对象。
         */
        this.offset = new ThemeOffset();

        /**
         * @member {boolean} [Ekmap.ThemeLabel.prototype.overlapAvoided=true]
        ...
        /**
         * @member {string} Ekmap.ThemeLabel.prototype.rangeExpression
        ...
        /**
         * @member {string} Ekmap.ThemeLabel.prototype.uniqueExpression
        ...
        /**
         * @member {boolean} [Ekmap.ThemeLabel.prototype.smallGeometryLabeled=false]
        ...
        /**
         * @member {Ekmap.ThemeLabelText} Ekmap.ThemeLabel.prototype.text
         * @description 标签中文本风格。
         */
        this.text = new ThemeLabelText();

        /**
         * @member {number} [Ekmap.ThemeLabel.prototype.textSpace=0]
        ...
        this.CLASS_NAME = "Ekmap.ThemeLabel";
    }


    /**
     * @function Ekmap.ThemeLabel.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.ThemeLabel.prototype.toJSON
    ...
    /**
     * @function Ekmap.ThemeLabel.prototype.toServerJSONObject
    ...
    /**
     * @function Ekmap.ThemeLabel.fromObj
     * @description 从传入对象获取标签专题图类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeLabel} ThemeLabel 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
        ...
        if (cells) {
            ...
            for (let i = 0, len = cells.length; i < len; i++) {
                //TODO
                //lab.matrixCells.push(Ekmap.LabelMatrixCell.fromObj(cells[i]));
            }
        }
