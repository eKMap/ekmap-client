...
/**
 * @class Ekmap.FacilityAnalystSources3DService
...
export class FacilityAnalystSources3DService extends CommonServiceBase {
    ...
    constructor(url, options) {
        ...
        this.CLASS_NAME = "Ekmap.FacilityAnalystSources3DService";
    }


    /**
     * @function Ekmap.FacilityAnalystSources3DService.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.FacilityAnalystSources3DService.prototype.processAsync
     * @description 负责将客户端的查询参数传递到服务端。
     * @param {Ekmap.FacilityAnalystSources3DParameters} params - 最近设施分析参数类（源查找资源）
     */
    processAsync(params) {
...
Ekmap.FacilityAnalystSources3DService = FacilityAnalystSources3DService;