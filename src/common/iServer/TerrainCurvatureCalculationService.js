...
/**
 * @class Ekmap.TerrainCurvatureCalculationService
 ...
 * @example 例如：
 * (start code)
 * var myTerrainCurvatureCalculationService = new Ekmap.TerrainCurvatureCalculationService(url);
...
export class TerrainCurvatureCalculationService extends SpatialAnalystBase {
    ...
    constructor(url, options) {
        super(url, options);
        this.CLASS_NAME = "Ekmap.TerrainCurvatureCalculationService";
    }
    ...
    /**
     * @function Ekmap.TerrainCurvatureCalculationService.prototype.processAsync
     * @description 负责将客户端的查询参数传递到服务端。
     * @param {Ekmap.TerrainCurvatureCalculationParameters} parameter - 地形曲率计算参数类。
     */
    processAsync(parameter) {
        ...
        var jsonParameters = Ekmap.Util.toJSON(parameterObject);
...
Ekmap.TerrainCurvatureCalculationService = TerrainCurvatureCalculationService;