...
/**
 * @class Ekmap.SetLayerInfoService
...
export class SetLayerInfoService extends CommonServiceBase {
    ...
    constructor(url, options) {
        ...
        this.CLASS_NAME = "Ekmap.SetLayerInfoService";
    }
    ...
    /**
     * @function Ekmap.SetLayerInfoService.prototype.processAsync
     * @description 负责将客户端的更新参数传递到服务端。
     * @param {Object} params - 修改后的图层资源信息。
     *        该参数可以使用获取图层信息服务<{@link Ekmap.GetLayersInfoService}>返回图层信息，解析结果result.subLayers.layers[i]，然后对其属性进行修改来获取。
     */
    processAsync(params) {
        if (!params) {
            return;
...
Ekmap.SetLayerInfoService = SetLayerInfoService;