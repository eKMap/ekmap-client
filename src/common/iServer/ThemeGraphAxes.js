...
/**
 * @class Ekmap.ThemeGraphAxes
 * @category  iServer Map Theme
 * @classdesc 统计专题图坐标轴样式类。
 * @param {Object} options - 参数。
 * @param {Ekmap.ServerColor} [options.axesColor=(0, 0, 0)] - 坐标轴颜色。
 ...
 * @param {Ekmap.ServerTextStyle} [options.axesTextStyle] - 统计符号的最大最小尺寸。
 */
export class ThemeGraphAxes {
    ...
    constructor(options) {
        ...
        /**
         * @member {Ekmap.ServerColor} [Ekmap.ThemeGraphAxes.prototype.axesColor=(0, 0, 0)]
         * @description 坐标轴颜色。当 axesDisplayed = true 时有效。
         */
        this.axesColor = new ServerColor(0, 0, 0);

        /**
         * @member {boolean} [Ekmap.ThemeGraphAxes.prototype.axesDisplayed=false]
        ...
        /**
         * @member {boolean} [Ekmap.ThemeGraphAxes.prototype.axesGridDisplayed=false]
         * @description 是否在统计图坐标轴上显示网格。
         */
        this.axesGridDisplayed = false;

        /**
         * @member {boolean} [Ekmap.ThemeGraphAxes.prototype.axesTextDisplayed=false]
         * @description 是否显示坐标轴的文本标注。
         */
        this.axesTextDisplayed = false;

        /**
         * @member {Ekmap.ServerTextStyle} Ekmap.ThemeGraphAxes.prototype.axesTextStyle
        ...
        this.CLASS_NAME = "Ekmap.ThemeGraphAxes";
    }

    /**
     * @function Ekmap.ThemeGraphAxes.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeGraphAxes.fromObj
     * @description 从传入对象获取统计专题图坐标轴样式类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeGraphAxes} ThemeGraphAxes 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
...
Ekmap.ThemeGraphAxes = ThemeGraphAxes;