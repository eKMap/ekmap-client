...
/**
 * @class Ekmap.FacilityAnalystSinks3DParameters
...
export class FacilityAnalystSinks3DParameters extends FacilityAnalyst3DParameters {
    ...
    constructor(options) {
        super(options);
        this.CLASS_NAME = "Ekmap.FacilityAnalystSinks3DParameters";
    }


    /**
     * @function Ekmap.FacilityAnalystSinks3DParameters.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
...
Ekmap.FacilityAnalystSinks3DParameters = FacilityAnalystSinks3DParameters;