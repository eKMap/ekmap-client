...
/**
 * @class Ekmap.LabelMixedTextStyle
 ...
 * @param {Ekmap.ServerTextStyle} [options.defaultStyle] - 默认的文本复合风格。
 ...
 * @param {Array.<Ekmap.ServerTextStyle>} [options.styles] - 文本样式集合。
 */
export class LabelMixedTextStyle {

    constructor(options) {
        /**
         * @member {Ekmap.ServerTextStyle} Ekmap.LabelMixedTextStyle.prototype.defaultStyle
         * @description 默认的文本复合风格，即 Ekmap.ServerTextStyle 各字段的默认值。
         */
        this.defaultStyle = null;

        /**
         * @member {string} Ekmap.LabelMixedTextStyle.prototype.separator
        ...
        /**
         * @member {boolean} [Ekmap.LabelMixedTextStyle.prototype.separatorEnabled=false]
        ...
        /**
         * @member {Array.<number>} Ekmap.LabelMixedTextStyle.prototype.splitIndexes
        ...
        /**
         * @member {Array.<Ekmap.ServerTextStyle>} Ekmap.LabelMixedTextStyle.prototype.styles
        ...
        this.CLASS_NAME = "Ekmap.LabelMixedTextStyle"
    }

    /**
     * @function Ekmap.LabelMixedTextStyle.prototype.destroy
    ...
    /**
     * @function Ekmap.LabelMixedTextStyle.fromObj
     * @description 从传入对象获取标签文本复合风格类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.LabelMixedTextStyle} 返回新的 LabelMixedTextStyle 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
...
Ekmap.LabelMixedTextStyle = LabelMixedTextStyle;