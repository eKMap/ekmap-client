...
/**
 * @class Ekmap.ServerTextStyle
 * @category  iServer Map Theme
 * @classdesc 服务端文本风格类。
 * @description 该类用于定义文本风格的相关属性。
 * @param {Object} options - 参数。
 * @param {Ekmap.TextAlignment} [options.align=Ekmap.TextAlignment.BASELINECENTER] - 文本的对齐方式。
 * @param {Ekmap.ServerColor} [options.backColor] - 文本的背景色。默认 backColor = new ServerColor(255, 255, 255)。
 * @param {Ekmap.ServerColor} [options.foreColor] - 文本的前景色。默认 foreColor = new ServerColor(0, 0, 0)。
...
export class ServerTextStyle {
    ...
    constructor(options) {
        /**
         * @member {Ekmap.TextAlignment} [Ekmap.ServerTextStyle.prototype.align= Ekmap.TextAlignment.BASELINECENTER]
         * @description 文本的对齐方式。
         */
        this.align = TextAlignment.BASELINECENTER;

        /**
         * @member {Ekmap.ServerColor} [Ekmap.ServerTextStyle.prototype.backColor=(255, 255, 255)]
         * @description 文本的背景色。
         */
        this.backColor = new ServerColor(255, 255, 255);

        /**
         * @member {Ekmap.ServerColor} [Ekmap.ServerTextStyle.prototype.foreColor=(0, 0, 0)]
         * @description 文本的前景色。
         */
        this.foreColor = new ServerColor(0, 0, 0);

        /**
         * @member {boolean} [Ekmap.ServerTextStyle.prototype.backOpaque=false]
         * @description 文本背景是否不透明。true 表示文本背景不透明。
         */
        this.backOpaque = false;

        /**
         * @member {boolean} [Ekmap.ServerTextStyle.prototype.sizeFixed=true]
         * @description 文本大小是否固定。设置为 true，表示图片为固定像素大小，具体大小请参考 fontHeight。当设为 false 时，图片会随着地图缩放而缩放。
         */
        this.sizeFixed = true;

        /**
         * @member {number} [Ekmap.ServerTextStyle.prototype.fontHeight=6]
        ...
        /**
         * @member {number} [Ekmap.ServerTextStyle.prototype.fontWidth=0]
         * @description 文本字体的宽度。字体的宽度以英文字符为标准，由于一个中文字符相当于两个英文字符。
         */
        this.fontWidth = 0;

        /**
         * @member {number} [Ekmap.ServerTextStyle.prototype.fontWeight=400]
         * @description 文本字体的磅数。表示粗体的具体数值。取值范围为从0－900之间的整百数。
         */
        this.fontWeight = 400;

        /**
         * @member {string} [Ekmap.ServerTextStyle.prototype.fontName="Times New Roman"]
         * @description 文本字体的名称。
         */
        this.fontName = "Times New Roman";

        /**
         * @member {boolean} [Ekmap.ServerTextStyle.prototype.bold=false]
         * @description 文本是否为粗体字。true 表示为粗体。false 表示文本不是粗体字。
         */
        this.bold = false;

        /**
         * @member {boolean} [Ekmap.ServerTextStyle.prototype.italic=false]
         * @description 文本是否采用斜体。true 表示采用斜体。
         */
        this.italic = false;

        /**
         * @member {number} [Ekmap.ServerTextStyle.prototype.italicAngle=0]
        ...
        /**
         * @member {boolean} [Ekmap.ServerTextStyle.prototype.shadow=false]
         * @description 文本是否有阴影。true 表示给文本增加阴影。false 表示文本没有阴影。
         */
        this.shadow = false;

        /**
         * @member {boolean} [Ekmap.ServerTextStyle.prototype.strikeout=false]
         * @description 文本字体是否加删除线。true 表示加删除线。false 表示文本字体不加删除线。
         */
        this.strikeout = false;

        /**
         * @member {boolean} [Ekmap.ServerTextStyle.prototype.outline=false]
         * @description 是否以轮廓的方式来显示文本的背景。true 表示以轮廓的方式来显示文本的背景。false 表示不以轮廓的方式来显示文本的背景。
         */
        this.outline = false;

        /**
         * @member {number} [Ekmap.ServerTextStyle.prototype.opaqueRate=0]
         * @description 注记文字的不透明度。不透明度的范围为0-100。0表示透明。
         */
        this.opaqueRate = 0;

        /**
         * @member {boolean} [Ekmap.ServerTextStyle.prototype.underline=false]
         * @description 文本字体是否加下划线。true 表示加下划线。
         */
        this.underline = false;

        /**
         * @member {number} [Ekmap.ServerTextStyle.prototype.rotation=0.0]
        ...
        this.CLASS_NAME = "Ekmap.ServerTextStyle";
    }


    /**
     * @function Ekmap.ServerTextStyle.prototype.destroy
    ...
    /**
     * @function Ekmap.ServerTextStyle.fromObj
     * @description 从传入对象获服务端文本风格类。
     * @param {Object} obj - 传入对象
     * @returns {Ekmap.ServerTextStyle} 返回服务端文本风格对象
     */
    static fromObj(obj) {
...
Ekmap.ServerTextStyle = ServerTextStyle;