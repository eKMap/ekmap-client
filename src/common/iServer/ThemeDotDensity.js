 ...
 * @param {Ekmap.ServerStyle} [options.style] - 点密度专题图中点的风格。
...
export class ThemeDotDensity extends Theme {
    ...
    constructor(options) {
        ...
        /**
         * @member {string} Ekmap.ThemeDotDensity.prototype.dotExpression
         * @description 创建点密度专题图的字段或字段表达式。点的数目或密集程度的来源。
         */
        this.dotExpression = null;

        /**
         * @member {Ekmap.ServerStyle} Ekmap.ThemeDotDensity.prototype.style
         * @description 点密度专题图中点的风格。
         */
        this.style = new ServerStyle();

        /**
         * @member {number} Ekmap.ThemeDotDensity.prototype.value
        ...
        this.CLASS_NAME = "Ekmap.ThemeDotDensity";
    }

    /**
     * @function Ekmap.ThemeDotDensity.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeDotDensity.prototype.toServerJSONObject
    ...
    /**
     * @function Ekmap.ThemeDotDensity.fromObj
     * @description 从传入对象获取点密度专题图中点的风格。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeDotDensity} ThemeDotDensity 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
...
Ekmap.ThemeDotDensity = ThemeDotDensity;