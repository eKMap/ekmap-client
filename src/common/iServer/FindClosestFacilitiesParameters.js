...
/**
 * @class Ekmap.FindClosestFacilitiesParameters
 * @category iServer NetworkAnalyst ClosestFacility
 * @classdesc 最近设施分析参数类。
 * @param {Object} options - 参数。 
 * @param {(Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point|number)} options.event - 事件点，一般为需要获得服务设施服务的事件位置。 
 * @param {Array.<Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point|number>}  options.facilities - 设施点集合，一般为提供服务的服务设施位置。 
...
export class FindClosestFacilitiesParameters {
    ...
    constructor(options) {
        /**
         * @member {(Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point|number)} Ekmap.FindClosestFacilitiesParameters.prototype.event
        ...
        /**
         * @member {number} [Ekmap.FindClosestFacilitiesParameters.prototype.expectFacilityCount=1]
         * @description 要查找的设施点数量。
         */
        this.expectFacilityCount = 1;

        /**
         * @member {Array.<Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point|number>} [Ekmap.FindClosestFacilitiesParameters.prototype.facilities=false]
        ...
        /**
         * @member {boolean} [Ekmap.FindClosestFacilitiesParameters.prototype.fromEvent=false]
        ...
        /**
         * @member {boolean} [Ekmap.FindClosestFacilitiesParameters.prototype.isAnalyzeById=false]
         * @description 事件点和设施点是否通过节点 ID 号来指定，设置为 false，表示通过坐标点指定事件点和设施点。
         */
        this.isAnalyzeById = false;

        /**
         * @member {number} [Ekmap.FindClosestFacilitiesParameters.prototype.maxWeight=0]
        ...
        /**
         * @member {Ekmap.TransportationAnalystParameter} [Ekmap.FindClosestFacilitiesParameters.prototype.parameter]
         * @description 交通网络分析通用参数。通过本类可以设置障碍边、障碍点、权值字段信息的名称标识、转向权值字段等信息。
         *              它为 Ekmap.TransportationAnalystParameter 类型，虽然为可选参数，但是如果不设置其中的 resultSetting 字段，
         *              则返回结果空间信息等都为空。
         */
        this.parameter = new TransportationAnalystParameter();
        Util.extend(this, options);

        this.CLASS_NAME = "Ekmap.FindClosestFacilitiesParameters";
    }

    /**
     * @function Ekmap.FindClosestFacilitiesParameters.prototype.destroy
...
Ekmap.FindClosestFacilitiesParameters = FindClosestFacilitiesParameters;