...
/**
 * @class Ekmap.FacilityAnalystStreamParameters
...
export class FacilityAnalystStreamParameters {
    ...
    constructor(options) {
        /**
         * @member {Array.<number>} [Ekmap.FacilityAnalystStreamParameters.prototype.sourceNodeIDs]
         * @description 指定的设施点 ID 数组。
         */
        this.sourceNodeIDs = null;

        /**
         * @member {number} [Ekmap.FacilityAnalystStreamParameters.prototype.edgeID]
         * @description 指定的弧段 ID，edgeID 与 nodeID 必须指定一个。 
         */
        this.edgeID = null;

        /**
         * @member {number} [Ekmap.FacilityAnalystStreamParameters.prototype.nodeID]
         * @description 指定的结点 ID，edgeID 与 nodeID 必须指定一个。 
         */
        this.nodeID = null;

        /**
         * @member {boolean} [Ekmap.FacilityAnalystStreamParameters.prototype.isUncertainDirectionValid=false]
        ...
        /**
         * @member {number} Ekmap.FacilityAnalystStreamParameters.prototype.queryType
         * @description 分析类型，只能是 0 (上游关键设施查询) 或者是 1（下游关键设施查询）。
         */
        this.queryType = null;
        Util.extend(this, options);
        this.CLASS_NAME = "Ekmap.FacilityAnalystStreamParameters";
    }


    /**
     * @function Ekmap.FacilityAnalystStreamParameters.prototype.destroy
...
Ekmap.FacilityAnalystStreamParameters = FacilityAnalystStreamParameters;