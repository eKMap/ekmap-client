...
export class ThemeOffset {
    ...
    constructor(options) {
        /**
         * @member {boolean} [Ekmap.ThemeOffset.prototype.offsetFixed=false]
         * @description 当前专题图是否固定标记文本或符号的偏移量。所谓固定偏移量，则文本或符号的偏移量不随地图的缩放而变化。
         */
        this.offsetFixed = false;

        /**
         * @member {string} [Ekmap.ThemeOffset.prototype.offsetX=0.0]
        ...
        /**
         * @member {string} [Ekmap.ThemeOffset.prototype.offsetY=0.0]
        ...
        this.CLASS_NAME = "Ekmap.ThemeOffset";
    }

    /**
     * @function Ekmap.ThemeOffset.prototype.destroy
    ...
    /**
     * @function Ekmap.ThemeOffset.fromObj
     * @description 从传入对象获取专题图中文本或符号相对于要素内点的偏移量设置类。
     * @param {Object} obj - 传入对象。
     * @returns {Ekmap.ThemeOffset} ThemeOffset 对象。
     */
    static fromObj(obj) {
        if (!obj) {
            return;
