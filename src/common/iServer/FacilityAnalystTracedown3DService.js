...
/**
 * @class Ekmap.FacilityAnalystTracedown3DService
...
export class FacilityAnalystTracedown3DService extends CommonServiceBase {
    ...
    constructor(url, options) {
        super(url, options);
        this.CLASS_NAME = "Ekmap.FacilityAnalystTracedown3DService";
    }

    /**
     * @function Ekmap.FacilityAnalystTracedown3DService.prototype.destroy
     * @override
     */
    destroy() {
        super.destroy();
    ...
    /**
     * @function Ekmap.FacilityAnalystTracedown3DService.prototype.processAsync
     * @description 负责将客户端的查询参数传递到服务端。
     * @param {Ekmap.FacilityAnalystTracedown3DParameters} params - 下游追踪资源参数类。
     */
    processAsync(params) {
...
Ekmap.FacilityAnalystTracedown3DService = FacilityAnalystTracedown3DService;