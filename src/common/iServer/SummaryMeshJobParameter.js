...
/**
 * @class Ekmap.SummaryMeshJobParameter
 ...
 * @param {Ekmap.StatisticAnalystMode} [options.statisticModes=Ekmap.StatisticAnalystMode.AVERAGE] - 分析模式。
 * @param {number} [options.meshType=0] - 分析类型。
 * @param {Ekmap.SummaryType} [options.type=Ekmap.SummaryType.SUMMARYMESH] - 聚合类型。
...
export class SummaryMeshJobParameter {
    ...
    constructor(options) {
        ...
        /**
         * @member {string} Ekmap.SummaryMeshJobParameter.prototype.datasetName
         * @description 数据集名。
         */
        this.datasetName = "";

        /**
         * @member {string} Ekmap.SummaryMeshJobParameter.prototype.regionDataset
         * @description 聚合面数据集（聚合类型为多边形聚合时使用的参数）。
         */
        this.regionDataset = "";

        /**
         * @member {(Ekmap.Bounds|L.Bounds|ol.extent)} Ekmap.SummaryMeshJobParameter.prototype.query
         * @description 分析范围（聚合类型为网格面聚合时使用的参数）。
         */
        this.query = "";

        /**
         * @member {number} [Ekmap.SummaryMeshJobParameter.prototype.resolution=100]
         * @description 分辨率（聚合类型为网格面聚合时使用的参数）。
         */
        this.resolution = 100;

        /**
         * @member {number} [Ekmap.SummaryMeshJobParameter.prototype.meshType=0]
         * @description  网格面类型（聚合类型为网格面聚合时使用的参数），取值：0 或 1。
         */
        this.meshType = 0;

        /**
         * @member {Ekmap.StatisticAnalystMode} [Ekmap.SummaryMeshJobParameter.prototype.statisticModes=Ekmap.StatisticAnalystMode.AVERAGE]
         * @description 统计模式。
         */
        this.statisticModes = StatisticAnalystMode.AVERAGE;

        /**
         * @member {number} Ekmap.SummaryMeshJobParameter.prototype.fields
         * @description 权重字段。
         */
        this.fields = "";

        /**
         * @member {Ekmap.SummaryType} [Ekmap.SummaryMeshJobParameter.prototype.type=Ekmap.SummaryType.SUMMARYMESH]
         * @description 聚合类型。
         */
        this.type = SummaryType.SUMMARYMESH;

        /**
         * @member {Ekmap.OutputSetting} [Ekmap.SummaryMeshJobParameter.prototype.output]
         * @description 输出参数设置类。
         */
        this.output = null;

        /**
         * @member {Ekmap.MappingParameters} [Ekmap.SummaryMeshJobParameter.prototype.mappingParameters]
        ...
        this.CLASS_NAME = "Ekmap.SummaryMeshJobParameter";
    }


    /**
     * @function Ekmap.SummaryMeshJobParameter.destroy
     * @override
     */
    destroy() {
    ...
    /**
     * @function Ekmap.SummaryMeshJobParameter.toObject
...
Ekmap.SummaryMeshJobParameter = SummaryMeshJobParameter;