 ...
 * @param {Ekmap.Bounds} [options.bounds] - 数据集范围，该字段只读。 
 ...
 * @param {Ekmap.Projection} [options.prjCoordSys] - 数据集的投影信息。 
...
export class DatasetInfo {
    ...
    constructor(options) {
        ...
        /**
         * @member {Ekmap.Bounds} [Ekmap.DatasetInfo.prototype.bounds]
         * @description 数据集范围，该字段只读。
         */
        this.bounds = null;

        /**
         * @member {string} [Ekmap.DatasetInfo.prototype.dataSourceName]
         * @description 数据源名称，该字段只读。
         */
        this.dataSourceName = null;

        /**
         * @member {string} [Ekmap.DatasetInfo.prototype.description]
         * @description 数据集的描述信息。
         */
        this.description = null;

        /**
         * @member {string} [Ekmap.DatasetInfo.prototype.encodeType]
         * @description 数据集存储时的压缩编码方式，该字段只读。
         */
        this.encodeType = null;

        /**
         * @member {boolean} [Ekmap.DatasetInfo.prototype.isReadOnly]
         * @description 数据集是否为只读。
         */
        this.isReadOnly = null;

        /**
         * @member {string} Ekmap.DatasetInfo.prototype.name
         * @description 数据集名称，该字段必须且只读。
         */
        this.name = null;

        /**
         * @member {Ekmap.Projection} [Ekmap.DatasetInfo.prototype.prjCoordSys]
         * @description 数据集的投影信息。
         */
        this.prjCoordSys = null;

        /**
         * @member {string} [Ekmap.DatasetInfo.prototype.tableName]
         * @description 表名，该字段只读。
         */
        this.tableName = null;

        /**
         * @member {string} Ekmap.DatasetInfo.prototype.type
        ...
        this.CLASS_NAME = "Ekmap.DatasetInfo";
    }

    /**
     * @function Ekmap.DatasetInfo.prototype.destroy
    ...
    /**
     * @function Ekmap.DatasetInfo.prototype.toServerJSONObject
