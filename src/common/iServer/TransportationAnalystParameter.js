...
/**
 * @class Ekmap.TransportationAnalystParameter
 ...
 * @param {Ekmap.TransportationAnalystResultSetting} options.resultSetting - 分析结果返回内容。
 * @param {Array.<(Ekmap.Geometry.Point|L.Point|L.LatLng|ol.geom.Point)>} [options.barrierPoints] - 网络分析中 Point2D 类型的障碍点数组。
...
export class TransportationAnalystParameter {
    ...
    constructor(options) {
        ...
        /**
         * @member {Array.<number>} Ekmap.TransportationAnalystParameter.prototype.barrierEdgeIDs
         * @description 网络分析中障碍弧段的 ID 数组。弧段设置为障碍边之后，表示双向都不通。
         */
        this.barrierEdgeIDs = null;

        /**
         * @member {Array.<number>} Ekmap.TransportationAnalystParameter.prototype.barrierNodeIDs
         * @description 网络分析中障碍点的 ID 数组。结点设置为障碍点之后，表示任何方向都不能通过此结点。
         */
        this.barrierNodeIDs = null;

        /**
         * @member {Array.<(Ekmap.Geometry.Point|L.Point|L.LatLng|ol.geom.Point)>}  Ekmap.TransportationAnalystParameter.prototype.barrierPoints
        ...
        /**
         * @member {string} [Ekmap.TransportationAnalystParameter.prototype.weightFieldName]
        ...
        /**
         * @member {string} Ekmap.TransportationAnalystParameter.prototype.turnWeightField
         * @description 转向权重字段的名称。
         */
        this.turnWeightField = null;

        /**
         *  @member {Ekmap.TransportationAnalystResultSetting} Ekmap.TransportationAnalystParameter.prototype.resultSetting
        ...
        this.CLASS_NAME = "Ekmap.TransportationAnalystParameter";
    }

    /**
     * @function Ekmap.TransportationAnalystParameter.prototype.destroy
...
Ekmap.TransportationAnalystParameter = TransportationAnalystParameter;