...
/**
 * @class Ekmap.QueryByGeometryService
 * @category  iServer Map QueryResults
 * @classdesc Geometry查询服务类。
 * @extends {Ekmap.QueryService}
 * @example
 * var myQueryByGeometryService = new Ekmap.QueryByGeometryService(url, {
 *     eventListeners: {
...
export class QueryByGeometryService extends QueryService {
    ...
    /**
     * @function Ekmap.QueryByGeometryService.prototype.constructor
    ...
    constructor(url, options) {
        super(url, options);
        this.CLASS_NAME = "Ekmap.QueryByGeometryService";
    }
    ...
    /**
     * @function Ekmap.QueryByGeometryService.prototype.getJsonParameters
     * @description 将查询参数转化为 JSON 字符串。
     *              在本类中重写此方法，可以实现不同种类的查询（sql, geometry, distance, bounds等）。
     * @param {Ekmap.QueryByGeometryParameters} params - Geometry 查询参数类。
...
Ekmap.QueryByGeometryService = QueryByGeometryService;