...
/**
 * @class Ekmap.FindServiceAreasParameters
 ...
 * @param {Array.<Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point|number>} options.centers - 服务站点数组。 
...
export class FindServiceAreasParameters {
    ...
    constructor(options) {
        /**
         * @member {boolean} [Ekmap.FindServiceAreasParameters.prototype.isAnalyzeById=false]
         * @description 是否通过节点 ID 指定路径分析的结点。
         *              指定路径分析经过的结点或设施点有两种方式：输入结点 ID 号或直接输入点坐标。
         *              当该字段为 true 时，表示通过结点 ID 指定途经点，即 Ekmap.FindServiceAreasParameters.centers = [ID1,ID2,...]；
         *              反之表示通过结点坐标指定途经点，即 Ekmap.FindServiceAreasParameters.centers = [{x1,y1},{x2,y2},...]。
         */
        this.isAnalyzeById = false;

        /**
         * @member {boolean} [Ekmap.FindServiceAreasParameters.prototype.isCenterMutuallyExclusive=false]
        ...
        /**
         * @member {Array.<Ekmap.Geometry.Point|L.LatLng|L.Point|ol.geom.Point|number>} Ekmap.FindServiceAreasParameters.prototype.centers
         * @description 服务站点数组。
        ...
        /**
         * @member {boolean} [Ekmap.FindServiceAreasParameters.prototype.isFromCenter=false]
        ...
        /**
         * APIProperty: weights
         * @member {Array.<number>} Ekmap.FindServiceAreasParameters.prototype.weights
        ...
        /**
         * @member {Ekmap.TransportationAnalystParameter} Ekmap.FindServiceAreasParameters.prototype.parameter
        ...
        this.CLASS_NAME = "Ekmap.FindServiceAreasParameters";
    }

    /**
     * @function Ekmap.FindServiceAreasParameters.prototype.destroy
...
Ekmap.FindServiceAreasParameters = FindServiceAreasParameters;