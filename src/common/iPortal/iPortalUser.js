...
export class IPortalUser extends IPortalServiceBase {
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.deleteResources
     * @description 删除资源。
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.addMap
     * @description 添加地图。
     * @version 10.1.0
     * @param {Ekmap.iPortalAddResourceParam} addMapParams - 添加地图的参数。
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.addScene
     * @description 添加场景。
     * @version 10.1.0
     * @param {Ekmap.iPortalAddResourceParam} addSceneParams - 添加场景的参数。
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.registerService
     * @description 注册服务。
     * @version 10.1.0
     * @param {Ekmap.iPortalRegisterServiceParam} registerParams - 注册服务的参数。
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.getErrMsgPromise
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.uploadDataRequest
     * @description 上传数据。
     * @version 10.1.0
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.addData
     * @description 上传/注册数据。
     * @version 10.1.0
     * @param {Ekmap.iPortalAddDataParam} params - 上传/注册数据所需的参数。
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.publishOrUnpublish
     * @description 发布/取消发布。
     * @version 10.1.0
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.getDataPublishedStatus
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.unPublishedDataService
     * @description 取消发布。
     * @version 10.1.0
    ...
    /**
     * @function Ekmap.iPortalUser.prototype.publishedDataService
     * @description 发布数据服务。
     * @version 10.1.0
